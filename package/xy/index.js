...
exports['src::os.name'] = (() => {
    ...
    let var_once_value_1626179830146;
    ...
    return function() {
        ...
        if (var_once_value_1626179830146) {

            return var_once_value_1626179830146;

        }
        return var_once_value_1626179830146 = main.call(this);
...
exports['src::mindmap'] = (() => {
    ...
    return function(config) {
        ...
        if (!var_init_locked_1626179830803) {
            ...
            var_class_1626179830803 = class extends main {
                ...
                get __ZBEE_CURRENT_CLASS__() {
                    ...
                    return var_class_1626179830803;
                }
            ...
            main = var_class_1626179830803;

            var_global_main_1626179830803 = main;

            var_init_locked_1626179830803 = true;
        }


        return new var_global_main_1626179830803(config);
    };
...
exports['src::mindmap.node.create'] = (() => {
    ...
    let var_init_locked_1626179830825;



    const var_current_scope_1626179830825 = new Map();

    return function(node = {}) {


        if (!var_init_locked_1626179830825) {

            isString = include('src::is.string');

            var_init_locked_1626179830825 = true;
        }




        if (!var_current_scope_1626179830825.has(this)) {

            var_current_scope_1626179830825.set(this, (() => {
        ...
        const main = var_current_scope_1626179830825.get(this);
...
exports['src::mindmap.node.field.hidden'] = (() => {
    ...
    const var_current_scope_1626179830832 = new Map();
    ...
    return function(node, hidden) {
        ...
        if (!var_current_scope_1626179830832.has(this)) {

            var_current_scope_1626179830832.set(this, (() => {
        ...
        const main = var_current_scope_1626179830832.get(this);
...
exports['src::mindmap.constructor'] = (() => {
    ...
    let var_init_locked_1626179830819;



    const var_current_scope_1626179830819 = new Map();
    ...
    return function({
        ...
        if (!var_init_locked_1626179830819) {
            ...
            var_init_locked_1626179830819 = true;
        }




        if (!var_current_scope_1626179830819.has(this)) {

            var_current_scope_1626179830819.set(this, (() => {
        ...
        const main = var_current_scope_1626179830819.get(this);
...
exports['src::mindmap.save'] = (() => {
    ...
    const var_current_scope_1626179830845 = new Map();
    ...
    return function(fields = []) {
        ...
        if (!var_current_scope_1626179830845.has(this)) {

            var_current_scope_1626179830845.set(this, (() => {
        ...
        const main = var_current_scope_1626179830845.get(this);
...
exports['src::mindmap.node.expand'] = (() => {
    ...
    const var_current_scope_1626179830921 = new Map();
    ...
    return function(node) {
        ...
        if (!var_current_scope_1626179830921.has(this)) {

            var_current_scope_1626179830921.set(this, (() => {
                const show = include('src::mindmap.node.show').bind(this);
                const from = include('src::mindmap.node.from').bind(this);
        ...
        const main = var_current_scope_1626179830921.get(this);
...
exports['src::mindmap.node.sync.delete'] = (() => {
    ...
    const var_current_scope_1626179830902 = new Map();
    ...
    return function(node) {
        ...
        if (!var_current_scope_1626179830902.has(this)) {

            var_current_scope_1626179830902.set(this, (() => {
                const isRootNode = include('src::mindmap.node.is.root').bind(this);
                const getParentNode = include('src::mindmap.node.parent').bind(this);
        ...
        const main = var_current_scope_1626179830902.get(this);
...
exports['src::mindmap.node.delete'] = (() => {
    ...
    const var_current_scope_1626179830864 = new Map();
    ...
    return function(node) {
        ...
        if (!var_current_scope_1626179830864.has(this)) {

            var_current_scope_1626179830864.set(this, (() => {
                const getPreviousNode = include('src::mindmap.node.sibling.previous').bind(this);
                const data = include('src::mindmap.node.data').bind(this);
                const from = include('src::mindmap.node.from').bind(this);
        ...
        const main = var_current_scope_1626179830864.get(this);
...
exports['src::mindmap.refresh'] = (() => {
    ...
    let var_init_locked_1626179831561;



    const var_current_scope_1626179831561 = new Map();

    return function() {


        if (!var_init_locked_1626179831561) {

            from = include('src::math.region.from');
            getAnchorXY = include('src::math.region.xy.anchor');

            var_init_locked_1626179831561 = true;
        }




        if (!var_current_scope_1626179831561.has(this)) {

            var_current_scope_1626179831561.set(this, (() => {
        ...
        const main = var_current_scope_1626179831561.get(this);
...
exports['src::mindmap.layout'] = (() => {
    ...
    const var_current_scope_1626179831558 = new Map();
    ...
    return function() {
        ...
        if (!var_current_scope_1626179831558.has(this)) {

            var_current_scope_1626179831558.set(this, (() => {
        ...
        const main = var_current_scope_1626179831558.get(this);
...
exports['src::mindmap.node.sync.value.set'] = (() => {
    ...
    let var_init_locked_1626179831594;



    const var_current_scope_1626179831594 = new Map();

    return function(field, value, node) {


        if (!var_init_locked_1626179831594) {

            equals = include('src::data.equals');
            clone = include('src::data.clone');

            var_init_locked_1626179831594 = true;
        }




        if (!var_current_scope_1626179831594.has(this)) {

            var_current_scope_1626179831594.set(this, (() => {
                const from = include('src::mindmap.node.from').bind(this);
        ...
        const main = var_current_scope_1626179831594.get(this);
...
exports['src::mindmap.node.sync.append'] = (() => {
    ...
    const var_current_scope_1626179831598 = new Map();
    ...
    return function(node, parentNode) {
        ...
        if (!var_current_scope_1626179831598.has(this)) {

            var_current_scope_1626179831598.set(this, (() => {
                const create = include('src::mindmap.node.create').bind(this);
                const show = include('src::mindmap.node.show').bind(this);
        ...
        const main = var_current_scope_1626179831598.get(this);
...
exports['src::mindmap.node.sync.insert'] = (() => {
    ...
    const var_current_scope_1626179831605 = new Map();
    ...
    return function(insertNode, baseNode, region) {
        ...
        if (!var_current_scope_1626179831605.has(this)) {

            var_current_scope_1626179831605.set(this, (() => {
                const create = include('src::mindmap.node.create').bind(this);
                const isRootNode = include('src::mindmap.node.is.root').bind(this);
                const getParentNode = include('src::mindmap.node.parent').bind(this);
                const getPreviousNode = include('src::mindmap.node.sibling.previous').bind(this);
        ...
        const main = var_current_scope_1626179831605.get(this);
...
exports['src::mindmap.node.value.set'] = (() => {
    ...
    const var_current_scope_1626179831613 = new Map();
    ...
    return function(field, value, node) {
        ...
        if (!var_current_scope_1626179831613.has(this)) {

            var_current_scope_1626179831613.set(this, (() => {
                const fireChangeEvent = include('src::mindmap.fire.event.change').bind(this);
                const from = include('src::mindmap.node.from').bind(this);
                const data = include('src::mindmap.node.data').bind(this);
                const setValue = include('src::mindmap.node.sync.value.set').bind(this);
        ...
        const main = var_current_scope_1626179831613.get(this);
...
exports['src::mindmap.node.append'] = (() => {
    ...
    const var_current_scope_1626179831618 = new Map();
    ...
    return function(node, parentNode) {
        ...
        if (!var_current_scope_1626179831618.has(this)) {

            var_current_scope_1626179831618.set(this, (() => {
                const data = include('src::mindmap.node.data').bind(this);
                const from = include('src::mindmap.node.from').bind(this);
                const fireChangeEvent = include('src::mindmap.fire.event.change').bind(this);
                const getPreviousNode = include('src::mindmap.node.sibling.previous').bind(this);
        ...
        const main = var_current_scope_1626179831618.get(this);
...
exports['src::mindmap.node.insert'] = (() => {
    ...
    const var_current_scope_1626179831626 = new Map();
    ...
    return function(node, baseNode, region) {
        ...
        if (!var_current_scope_1626179831626.has(this)) {

            var_current_scope_1626179831626.set(this, (() => {
                const data = include('src::mindmap.node.data').bind(this);
                const getPreviousNode = include('src::mindmap.node.sibling.previous').bind(this);
                const from = include('src::mindmap.node.from').bind(this);
                const fireChangeEvent = include('src::mindmap.fire.event.change').bind(this);
                const getParentNode = include('src::mindmap.node.parent').bind(this);
                const insert = include('src::mindmap.node.sync.insert').bind(this);
        ...
        const main = var_current_scope_1626179831626.get(this);
...
exports['src::mindmap.layout.node.drag.move'] = (() => {
    ...
    let var_init_locked_1626179831726;



    const var_current_scope_1626179831726 = new Map();
    ...
    return function(node, {
        ...
        if (!var_init_locked_1626179831726) {

            getAnchorY = include('src::math.region.y.anchor');
            from = include('src::math.region.from');

            var_init_locked_1626179831726 = true;
        }




        if (!var_current_scope_1626179831726.has(this)) {

            var_current_scope_1626179831726.set(this, (() => {
        ...
        const main = var_current_scope_1626179831726.get(this);
...
exports['src::mindmap.layout.node.drag.end'] = (() => {
    ...
    const var_current_scope_1626179831730 = new Map();
    ...
    return function() {
        ...
        if (!var_current_scope_1626179831730.has(this)) {

            var_current_scope_1626179831730.set(this, (() => {
                const getDescendantNodes = include('src::mindmap.layout.nodes.descendant').bind(this);
                const getParentNode = include('src::mindmap.layout.node.parent').bind(this);
                const insertBefore = include('src::mindmap.node.insert.before').bind(this);
                const insertAfter = include('src::mindmap.node.insert.after').bind(this);
        ...
        const main = var_current_scope_1626179831730.get(this);
...
exports['src::mindmap.node.expand.deep'] = (() => {
    ...
    const var_current_scope_1626179831750 = new Map();
    ...
    return function(node, level = 1) {
        ...
        if (!var_current_scope_1626179831750.has(this)) {

            var_current_scope_1626179831750.set(this, (() => {
                const from = include('src::mindmap.node.from').bind(this);
                const expand = include('src::mindmap.node.expand').bind(this);
        ...
        const main = var_current_scope_1626179831750.get(this);
