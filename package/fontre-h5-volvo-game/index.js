...
exports['src::browser.animationFrame.set'] = (() => {
    ...
    return function(fn, scope) {
        ...
        if (!__first_executed_1534494806870__) {
            getMap = include('browser.animationFrame.map');

            __first_executed_1534494806870__ = true;
        }
...
exports['src::browser.animationFrame.stop'] = (() => {
    ...
    let __first_executed_1534494807637__ = false;
    ...
    return function(animationFrameId) {
        ...
        if (!__first_executed_1534494807637__) {
            getMap = include('browser.animationFrame.map');

            __first_executed_1534494807637__ = true;
        }
