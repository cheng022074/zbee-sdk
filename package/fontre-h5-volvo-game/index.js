...
exports['src::browser.animationFrame.stop'] = (() => {
    ...
    let __first_executed_1534494169680__ = false;
    ...
    return function(animationFrameId) {
        ...
        if (!__first_executed_1534494169680__) {
            getMap = include('browser.animationFrame.map');

            __first_executed_1534494169680__ = true;
        }
...
exports['src::browser.animationFrame.clear'] = (() => {
    ...
    return function(animationFrameId) {
        ...
        if (!__first_executed_1534494169680__) {
            stop = include('browser.animationFrame.stop');
            getMap = include('browser.animationFrame.map');
...
exports['src::random.range'] = (() => {
    ...
    function main(startValue, endValue) {
...
exports['src::browser.stopAnimationFrame'] = include('src::browser.animationFrame.stop');

exports['src::browser.clearAnimationFrame'] = include('src::browser.animationFrame.clear');

exports['src::browser.startAnimationFrame'] = include('src::browser.animationFrame.start');