...
exports['src::is.array'] = (() =>{
    ...
    let __first_executed_1541054909639__ = false ;
 ...
 return Array.isArray(data) ;
    ...
    return function(data){
        ...
        if(!__first_executed_1541054909639__){
            isType = include('is.type');
            
            __first_executed_1541054909639__ = true ;
        }
...
exports['src::is.empty'] = (() =>{
    ...
    let __first_executed_1541054909640__ = false ;
...
return (data == null) || (!allowEmptyString ? data === '' : false) || (isArray(data) && data.length === 0);
    ...
    return function(data,allowEmptyString = false){
        ...
        if(!__first_executed_1541054909640__){
            isArray = include('is.array');
            
            __first_executed_1541054909640__ = true ;
        }
