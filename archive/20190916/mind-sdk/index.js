...
exports['src::is.string'] = (() =>{
                ...
                let var_init_locked_1568620631372;
...
return isType(data , 'string') ;
        ...
        if(!var_init_locked_1568620631372){

            isType = include('is.type');

            var_init_locked_1568620631372 = true ;
        }
...
exports['src::is.class'] = (() =>{
                ...
                let var_init_locked_1568620631375;
...
return isType(data , 'function') && data.ZBEE_CLASS === true ;
        ...
        if(!var_init_locked_1568620631375){

            isType = include('is.type');

            var_init_locked_1568620631375 = true ;
        }
...
exports['src::is.function'] = (() =>{
                ...
                let var_init_locked_1568620631376;
...
return isType(data , 'function') && data.ZBEE_CLASS !== true;
        ...
        if(!var_init_locked_1568620631376){

            isType = include('is.type');

            var_init_locked_1568620631376 = true ;
        }
...
exports['src::class.create'] = (() =>{
                ...
                let var_init_locked_1568620631380;
...
exports['src::class.create.option'] = (() =>{
                ...
                let var_init_locked_1568620631386;
 ...
 */
 ...
 if(isString(option)){
    ...
    return create(namespace) ;
        ...
        if(!var_init_locked_1568620631386){
...
isDefined = include('is.defined');
            ...
            var_init_locked_1568620631386 = true ;
        }
...
exports['src::class.empty'] = (() =>{
                ...
                let var_once_value_1568620631387;
 ...
 */
 ...
 return class {
        ...
        if(var_once_value_1568620631387){

            return var_once_value_1568620631387 ;

        }
        return var_once_value_1568620631387 = main.call(this ) ;
...
exports['src::map.set'] = (() =>{
                ...
                let var_init_locked_1568620631397;

                let var_current_scope_1568620631397;
 ...
 */
 ...
 return me ;
        ...
        if(!var_current_scope_1568620631397 !== this){

            find = include('src::map.find').bind(this);

            var_current_scope_1568620631397 = this ;
        }
...
exports['src::map.get'] = (() =>{
                ...
                let var_init_locked_1568620631398;

                let var_current_scope_1568620631398;
...
if(match){
    ...
    return map.get(key) ;
        ...
        if(!var_current_scope_1568620631398 !== this){

            find = include('src::map.find').bind(this);

            var_current_scope_1568620631398 = this ;
        }
...
exports['src::map.has'] = (() =>{
                ...
                let var_init_locked_1568620631399;

                let var_current_scope_1568620631399;
 ...
 */
 ...
 return match ;
        ...
        if(!var_current_scope_1568620631399 !== this){

            find = include('src::map.find').bind(this);

            var_current_scope_1568620631399 = this ;
        }
...
exports['src::map.delete'] = (() =>{
                ...
                let var_init_locked_1568620631401;

                let var_current_scope_1568620631401;
...
return false ;
        ...
        if(!var_current_scope_1568620631401 !== this){

            find = include('src::map.find').bind(this);

            var_current_scope_1568620631401 = this ;
        }
...
exports['src::map.find.fuzzy'] = (() =>{
                ...
                let var_init_locked_1568620631407;
...
return result ;
        ...
        if(!var_init_locked_1568620631407){

            isDefined = include('is.defined');

            var_init_locked_1568620631407 = true ;
        }
...
exports['src::map'] = (() =>{
                ...
                let var_init_locked_1568620631411;

                let var_class_1568620631411;
        ...
        if(!var_init_locked_1568620631411){
...
isObject = include('is.object.simple');
            ...
            var_init_locked_1568620631411 = true ;
        }
        

                    
        if(!var_class_1568620631411){
...
find(...args){
            ...
            var_class_1568620631411 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1568620631411 ;
                }
                    ...
                    return new var_class_1568620631411();
                } ;
...
exports['src::event.listeners'] = (() =>{
                ...
                let var_init_locked_1568620631412;

                

                let var_once_value_1568620631412;
...
return map ;
        ...
        if(!var_init_locked_1568620631412){

            map = include('map')();

            var_init_locked_1568620631412 = true ;
        }
        ...
        if(var_once_value_1568620631412){

            return var_once_value_1568620631412 ;

        }
        return var_once_value_1568620631412 = main.call(this ) ;
...
exports['src::event.listener.remove'] = (() =>{
                ...
                let var_init_locked_1568620631415;
 ...
 */
 ...
 if(isString(name)){
    ...
    for(let name of names){
        ...
        if(!var_init_locked_1568620631415){
...
native = include('src::event.listener.native.remove');
            ...
            var_init_locked_1568620631415 = true ;
        }
...
exports['src::function.get'] = (() =>{
                ...
                let var_init_locked_1568620631420;
...
return empty() ;
        ...
        if(!var_init_locked_1568620631420){

            isString = include('is.string');
isFunction = include('is.function');
empty = include('function.empty');

            var_init_locked_1568620631420 = true ;
        }
...
exports['src::is.array'] = (() =>{
                ...
                let var_init_locked_1568620631422;
 ...
 */
 ...
 return Array.isArray(data) ;
        ...
        if(!var_init_locked_1568620631422){

            isType = include('is.type');

            var_init_locked_1568620631422 = true ;
        }
...
exports['src::event.listener.add'] = (() =>{
                ...
                let var_init_locked_1568620631430;
 ...
 */
 ...
 if(isString(name)){
    ...
    for(let config of name){
        ...
        if(!var_init_locked_1568620631430){
...
isArray = include('is.array');
            ...
            var_init_locked_1568620631430 = true ;
        }
...
exports['src::mixin.observable.constructor'] = (() =>{
                ...
                let var_init_locked_1568620631431;
...
function main({
    ...
    if(isObject(listeners) || isArray(listeners)){
        ...
        if(!var_init_locked_1568620631431){

            add = include('event.listener.add');
isObject = include('is.object.simple');
isArray = include('is.array');

            var_init_locked_1568620631431 = true ;
        }
...
exports['src::mixin.observable.event.fire'] = (() =>{
                ...
                let var_init_locked_1568620631436;
 ...
 */
 ...
 function doFireBubbleEvent(event , target , ...args){
    ...
    if(bubbleTarget){
        ...
        if(!var_init_locked_1568620631436){

            isArray = include('is.array');

            var_init_locked_1568620631436 = true ;
        }
...
exports['src::mixin.observable'] = (() =>{
                ...
                let var_init_locked_1568620631441;
...
resumeEvents(...args){
        ...
        if(!var_init_locked_1568620631441){
...
isObject = include('is.object.simple');
            ...
            var_init_locked_1568620631441 = true ;
        }
...
exports['src::is.object'] = (() =>{
                ...
                let var_init_locked_1568620631448;
...
return Object.prototype.toString.call(data) === '[object Object]' ;
        ...
        if(!var_init_locked_1568620631448){

            isType = include('is.type');

            var_init_locked_1568620631448 = true ;
        }
...
exports['src::object.value.get'] = (() =>{
                ...
                let var_init_locked_1568620631451;
...
function main(data , key , prefixKey = ''){
    ...
    if(isObject(data)){
        ...
        if(!var_init_locked_1568620631451){
...
join = include('object.key.join');
            ...
            var_init_locked_1568620631451 = true ;
        }
...
exports['src::is.empty'] = (() =>{
                ...
                let var_init_locked_1568620631452;
...
return (data == null) || (!allowEmptyString ? data === '' : false) || (isArray(data) && data.length === 0);
        ...
        if(!var_init_locked_1568620631452){

            isArray = include('is.array');

            var_init_locked_1568620631452 = true ;
        }
...
exports['src::array.from'] = (() =>{
                ...
                let var_init_locked_1568620631454;
...
return [
    data
        ...
        if(!var_init_locked_1568620631454){

            isEmpty = include('is.empty');
isString = include('is.string');

            var_init_locked_1568620631454 = true ;
        }
...
exports['src::data.reader.json'] = (() =>{
                ...
                let var_init_locked_1568620631457;
 ...
 */
 ...
 function generate_get_field_data({
   ...
   return result.join('') ;
        ...
        if(!var_init_locked_1568620631457){
...
getModel = include('data.model.get');
            ...
            var_init_locked_1568620631457 = true ;
        }
...
exports['src::data.proxy.constructor'] = (() =>{
                ...
                let var_init_locked_1568620631458;
...
exports['src::data.proxy.read'] = (() =>{
                ...
                let var_init_locked_1568620631461;
...
function main(options){
    ...
    if(isPromise(data)){
       ...
       data.then(data => fireReadEvent.call(me , data)) ;
        ...
        if(!var_init_locked_1568620631461){

            isPromise = include('is.promise');

            var_init_locked_1568620631461 = true ;
        }
...
exports['src::data.proxy'] = (() =>{
                ...
                let mixin_1568620631114__1,extend,constructor,method_read,isObject;

                let var_init_locked_1568620631462;

                let var_class_1568620631462;
        ...
        if(!var_init_locked_1568620631462){

            mixin_1568620631114__1 = include('mixin.observable');
extend = include('class.empty')();
constructor = include('src::data.proxy.constructor');
method_read = include('src::data.proxy.read');
isObject = include('is.object.simple');

            var_init_locked_1568620631462 = true ;
        }
        

                    
        if(!var_class_1568620631462){
            ...
            var_class_1568620631462 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1568620631462 ;
                }
...
exports['src::is.proxy.memory'] = (() =>{
                ...
                let var_init_locked_1568620631463;
 ...
 */
 ...
 return data instanceof Proxy && data.proxyType === 'memory' ;
        ...
        if(!var_init_locked_1568620631463){

            Proxy = include('data.proxy')();

            var_init_locked_1568620631463 = true ;
        }
...
exports['src::object.keys'] = (() =>{
                ...
                let var_init_locked_1568620631464;
...
function get_keys(data , rootKey = ''){
    ...
    return result ;
        ...
        if(!var_init_locked_1568620631464){

            isObject = include('is.object.simple');

            var_init_locked_1568620631464 = true ;
        }
...
exports['src::object.value.set'] = (() =>{
                ...
                let var_init_locked_1568620631465;
...
function main(target , key , value){
    ...
    if(splitRe.test(key)){
        ...
        if(!var_init_locked_1568620631465){

            isObject = include('is.object');
split = include('string.split');

            var_init_locked_1568620631465 = true ;
        }
...
exports['src::object.assign.if'] = (() =>{
                ...
                let var_init_locked_1568620631466;
...
function main(dest , ...sources){
    ...
    return dest ;
        ...
        if(!var_init_locked_1568620631466){

            getKeys = include('object.keys');
set = include('object.value.set');
get = include('object.value.get');

            var_init_locked_1568620631466 = true ;
        }
...
exports['src::data.model.base'] = (() =>{
                ...
                let var_init_locked_1568620631468;

                let var_class_1568620631468;
        ...
        if(!var_init_locked_1568620631468){
...
assign2 = include('object.assign.if');
            ...
            var_init_locked_1568620631468 = true ;
        }
        

                    
        if(!var_class_1568620631468){
 ...
 class main{
    ...
    onProxyRead(proxy , records){
        ...
        if(records.length){
            ...
            var_class_1568620631468 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1568620631468 ;
                }
...
exports['src::data.model.fields'] = (() =>{
                ...
                let var_init_locked_1568620631476;
...
class Fields{
 ...
 function getFieldIndex(name){
    ...
    return names.indexOf(name) ;
        ...
        if(!var_init_locked_1568620631476){
...
Store = include('data.store')();
            ...
            var_init_locked_1568620631476 = true ;
        }
...
exports['src::data.model.id'] = (() =>{
                ...
                let var_init_locked_1568620631480;
...
return me.$id = getId('model-') ;
        ...
        if(!var_init_locked_1568620631480){

            getId = include('id.generate');

            var_init_locked_1568620631480 = true ;
        }
...
exports['src::data.model.value.set'] = (() =>{
                ...
                let var_init_locked_1568620631487;
...
if(isObject(values)){
    ...
    return updateValues ;
        ...
        if(!var_init_locked_1568620631487){

            isString = include('is.string');
isObject = include('is.object.simple');

            var_init_locked_1568620631487 = true ;
        }
...
exports['src::data.model'] = (() =>{
                ...
                let mixin_1568620631110__1,extend,static_get_fields,get_isBindStore,get_id,method_bindStore,method_unbindStore,method_has,method_set,method_get,method_load,method_destroy,isObject;

                let var_init_locked_1568620631492;

                let var_class_1568620631492;
        ...
        if(!var_init_locked_1568620631492){

            mixin_1568620631110__1 = include('mixin.observable');
...
isObject = include('is.object.simple');
            ...
            var_init_locked_1568620631492 = true ;
        }
        

                    
        if(!var_class_1568620631492){
...
get id(){
            ...
            var_class_1568620631492 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1568620631492 ;
                }
...
exports['src::is.class.from'] = (() =>{
                ...
                let var_init_locked_1568620631494;
 ...
 */
 ...
 return isClass(data) && isClass(baseClass) && (data === baseClass || data.prototype instanceof baseClass) ;
        ...
        if(!var_init_locked_1568620631494){

            isClass = include('is.class');
isString = include('is.string');

            var_init_locked_1568620631494 = true ;
        }
...
exports['src::is.data.model.class'] = (() =>{
                ...
                let var_init_locked_1568620631495;
 ...
 */
 ...
 return isClass(data , 'data.model') ;
        ...
        if(!var_init_locked_1568620631495){

            dataModel = include('data.model');
isClass = include('is.class.from');

            var_init_locked_1568620631495 = true ;
        }
...
exports['src::data.model.create'] = (() =>{
                ...
                let var_init_locked_1568620631496;
 ...
 */
 ...
 function main({
    ...
    return define(class extends Model{
        ...
        if(!var_init_locked_1568620631496){

            Model = include('data.model')();
get = include('data.model.get');
define = include('class.define');

            var_init_locked_1568620631496 = true ;
        }
...
exports['src::object.assign'] = (() =>{
                ...
                let var_init_locked_1568620631497;
...
function main(dest , ...sources){
    ...
    return dest ;
        ...
        if(!var_init_locked_1568620631497){

            getKeys = include('object.keys');
set = include('object.value.set');
get = include('object.value.get');

            var_init_locked_1568620631497 = true ;
        }
...
exports['src::is.number'] = (() =>{
                ...
                let var_init_locked_1568620631499;
...
return isType(data , 'number') && isFinite(data);
        ...
        if(!var_init_locked_1568620631499){

            isType = include('is.type');

            var_init_locked_1568620631499 = true ;
        }
...
exports['src::is.boolean'] = (() =>{
                ...
                let var_init_locked_1568620631500;
...
return isType(data , 'boolean') ;
        ...
        if(!var_init_locked_1568620631500){

            isType = include('is.type');

            var_init_locked_1568620631500 = true ;
        }
...
exports['src::data.type'] = (() =>{
                ...
                let var_init_locked_1568620631504;
 ...
 */
 ...
 return 'other' ;
        ...
        if(!var_init_locked_1568620631504){
...
isDate = include('is.date');
            ...
            var_init_locked_1568620631504 = true ;
        }
...
exports['src::data.equals'] = (() =>{
                ...
                let var_init_locked_1568620631506;
 ...
 */
 ...
 function base_equals(value1 , value2){
    ...
    return value1 === value2 ;
        ...
        if(!var_init_locked_1568620631506){

            getType = include('data.type');

            var_init_locked_1568620631506 = true ;
        }
...
exports['src::array.remove'] = (() =>{
                ...
                let var_init_locked_1568620631507;
 ...
 */
 ...
 for(let item of items){
    ...
    remove(data , indexOf(data , item)) ;
        ...
        if(!var_init_locked_1568620631507){

            remove = include('array.remove.index');
indexOf = include('array.indexOf');

            var_init_locked_1568620631507 = true ;
        }
...
exports['src::is.data.model'] = (() =>{
                ...
                let var_init_locked_1568620631508;
 ...
 */
 ...
 return data instanceof Model ;
        ...
        if(!var_init_locked_1568620631508){

            Model = include('data.model')();

            var_init_locked_1568620631508 = true ;
        }
...
exports['src::data.recordset'] = (() =>{
                ...
                let var_init_locked_1568620631512;

                let var_class_1568620631512;
        ...
        if(!var_init_locked_1568620631512){
...
clone = include('array.clone');
            ...
            var_init_locked_1568620631512 = true ;
        }
        

                    
        if(!var_class_1568620631512){
 ...
 function resetRecordData(recordData){
    ...
    while((index = recordData.indexOf(undefined)) !== -1){
        ...
        removeIndex(recordData , index) ;
            ...
            var_class_1568620631512 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1568620631512 ;
                }
                    ...
                    return new var_class_1568620631512(store);
                } ;
...
exports['src::data.store.base'] = (() =>{
                ...
                let var_init_locked_1568620631513;

                let var_class_1568620631513;
        ...
        if(!var_init_locked_1568620631513){
...
createRecordset = include('data.recordset');
            ...
            var_init_locked_1568620631513 = true ;
        }
        

                    
        if(!var_class_1568620631513){
...
class main{
    ...
    onProxyRead(proxy , records){
        ...
        me.fireEvent('load' , records) ;
            ...
            var_class_1568620631513 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1568620631513 ;
                }
...
exports['src::object.link'] = (() =>{
                ...
                let var_init_locked_1568620631515;
 ...
 */
 ...
 for(let name of names){
    ...
    if(isFunction(value)){
        ...
        if(!var_init_locked_1568620631515){

            isFunction = include('is.function');

            var_init_locked_1568620631515 = true ;
        }
...
exports['src::data.store.constructor'] = (() =>{
                ...
                let var_init_locked_1568620631517;
...
link(me , recordset , [
    ...
    'getById'
        ...
        if(!var_init_locked_1568620631517){
...
link = include('object.link');
            ...
            var_init_locked_1568620631517 = true ;
        }
...
exports['src::data.store.remove'] = (() =>{
                ...
                let var_init_locked_1568620631521;
 ...
 */
 ...
 return records ;
        ...
        if(!var_init_locked_1568620631521){

            remove = include('array.remove');
from = include('array.from');

            var_init_locked_1568620631521 = true ;
        }
...
exports['src::data.store'] = (() =>{
                ...
                let mixin_1568620631082__1,extend,constructor,method_add,method_insert,method_remove,method_load,method_clear,method_getById,isObject;

                let var_init_locked_1568620631526;

                let var_class_1568620631526;
        ...
        if(!var_init_locked_1568620631526){

            mixin_1568620631082__1 = include('mixin.observable');
...
isObject = include('is.object.simple');
            ...
            var_init_locked_1568620631526 = true ;
        }
        

                    
        if(!var_class_1568620631526){
...
getById(...args){
            ...
            var_class_1568620631526 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1568620631526 ;
                }
...
exports['src::data.store.create'] = (() =>{
                ...
                let var_init_locked_1568620631527;
...
return create('data.store' , store) ;
        ...
        if(!var_init_locked_1568620631527){

            create = include('class.create.option');
srcDataStore = include('src::data.store');

            var_init_locked_1568620631527 = true ;
        }
...
exports['src::mixin.region.xy.anchor.set'] = (() =>{
                ...
                let var_init_locked_1568620631534;
...
switch(anchor){
   ...
   case 'b':
       ...
       return assign({
        ...
        if(!var_init_locked_1568620631534){

            isDefined = include('is.defined');

            var_init_locked_1568620631534 = true ;
        }
...
exports['src::mixin.region'] = (() =>{
                ...
                let var_init_locked_1568620631535;
...
exports['src::object.property.prefix'] = (() =>{
                ...
                let var_once_value_1568620631538;
...
return `$private-${Date.now()}-`;
        ...
        if(var_once_value_1568620631538){

            return var_once_value_1568620631538 ;

        }
        return var_once_value_1568620631538 = main.call(this ) ;
...
exports['src::object.property.define'] = (() =>{
                ...
                let var_init_locked_1568620631541;
 ...
 */
 ...
 Object.defineProperty(target , name , {
    ...
    get(){
        ...
        if(!var_init_locked_1568620631541){
...
isFunction = include('is.function');
            ...
            var_init_locked_1568620631541 = true ;
        }
...
exports['src::object.properties.define'] = (() =>{
                ...
                let var_init_locked_1568620631542;
 ...
 if(isArray(config)){
   ...
   for(let name of names){
      ...
      defineProperty(target , name , config[name]) ;
        ...
        if(!var_init_locked_1568620631542){

            defineProperty = include('object.property.define');
isArray = include('is.array');

            var_init_locked_1568620631542 = true ;
        }
...
exports['src::data.model.node.tree.base'] = (() =>{
                ...
                let var_init_locked_1568620631543;

                let var_class_1568620631543;
        ...
        if(!var_init_locked_1568620631543){
...
defineProperties = include('object.properties.define');
            ...
            var_init_locked_1568620631543 = true ;
        }
        

                    
        if(!var_class_1568620631543){
 ...
 class main extends Model{
    ...
    getChildren(){
        ...
        return store.findRecords('parentId' , id) ;
            ...
            var_class_1568620631543 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1568620631543 ;
                }
...
exports['src::data.model.node.tree.node.sibling.previous'] = (() =>{
                ...
                let var_init_locked_1568620631546;
 ...
 */
 ...
 return getSiblingNode(this , -1) ;
        ...
        if(!var_init_locked_1568620631546){

            getSiblingNode = include('src::data.model.node.tree.node.sibling');

            var_init_locked_1568620631546 = true ;
        }
...
exports['src::math.region'] = (() =>{
                ...
                let var_init_locked_1568620631558;

                let var_class_1568620631558;
        ...
        if(!var_init_locked_1568620631558){

            region = include('mixin.region');

            var_init_locked_1568620631558 = true ;
        }
        

                    
        if(!var_class_1568620631558){
   ...
   containTo(region){
      ...
      return {
         ...
         y:offsetY
            ...
            var_class_1568620631558 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1568620631558 ;
                }
                    ...
                    return new var_class_1568620631558({x , y , width , height});
                } ;
...
exports['src::data.model.node.tree.region'] = (() =>{
                ...
                let var_init_locked_1568620631559;
 ...
 */
 ...
 return createRegion({
     ...
     height
        ...
        if(!var_init_locked_1568620631559){

            createRegion = include('math.region');

            var_init_locked_1568620631559 = true ;
        }
...
exports['src::data.model.node.tree.select.up'] = (() =>{
                ...
                let var_init_locked_1568620631595;

                let var_current_scope_1568620631595;
...
return select('up') ;
        ...
        if(!var_current_scope_1568620631595 !== this){

            select = include('src::data.model.node.tree.select.vertical').bind(this);

            var_current_scope_1568620631595 = this ;
        }
...
exports['src::data.model.node.tree.select.down'] = (() =>{
                ...
                let var_init_locked_1568620631596;

                let var_current_scope_1568620631596;
 ...
 */
 ...
 return select('down') ;
        ...
        if(!var_current_scope_1568620631596 !== this){

            select = include('src::data.model.node.tree.select.vertical').bind(this);

            var_current_scope_1568620631596 = this ;
        }
...
exports['src::data.model.node.tree.select.right'] = (() =>{
                ...
                let var_init_locked_1568620631600;
...
if(firstChildNode){
    ...
    if(nearestNode){
        ...
        if(!var_init_locked_1568620631600){

            getDistance = include('math.point.distance');

            var_init_locked_1568620631600 = true ;
        }
...
exports['src::object.property.reset'] = (() =>{
                ...
                let var_init_locked_1568620631602;
...
delete target[`${getPrefix()}${name}`] ;
        ...
        if(!var_init_locked_1568620631602){

            getPrefix = include('object.property.prefix');

            var_init_locked_1568620631602 = true ;
        }
...
exports['src::data.model.node.tree.append'] = (() =>{
                ...
                let var_init_locked_1568620631604;
...
return nodes ;
        ...
        if(!var_init_locked_1568620631604){

            resetProperty = include('object.property.reset');

            var_init_locked_1568620631604 = true ;
        }
...
exports['src::data.model.node.tree.remove'] = (() =>{
                ...
                let var_init_locked_1568620631610;
...
if(cache.get('children').includes(node)){
    ...
    if(children.length === 0){
        ...
        if(!var_init_locked_1568620631610){

            remove = include('array.remove');

            var_init_locked_1568620631610 = true ;
        }
...
exports['src::data.model.node.tree'] = (() =>{
        ...
        if(!var_init_locked_1568620631615){

            mixin_1568620631183__1 = include('mixin.region');
...
isObject = include('is.object.simple');
            ...
            var_init_locked_1568620631615 = true ;
        }
        

                    
        if(!var_class_1568620631615){
...
get leafNodes(){
            ...
            var_class_1568620631615 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1568620631615 ;
                }
...
exports['src::data.model.node.tree.mind'] = (() =>{
                ...
                let var_init_locked_1568620631616;

                let var_class_1568620631616;
        ...
        if(!var_init_locked_1568620631616){

            Model = include('src::data.model.node.tree')();
isEmpty = include('is.object.empty');

            var_init_locked_1568620631616 = true ;
        }
        

                    
        if(!var_class_1568620631616){
    ...
    get width(){
     ...
     get height(){
         ...
         return this.get('height') ;
            ...
            var_class_1568620631616 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1568620631616 ;
                }
...
exports['src::data.store.tree.base'] = (() =>{
                ...
                let var_init_locked_1568620631620;

                let var_class_1568620631620;
        ...
        if(!var_init_locked_1568620631620){
...
from = include('array.from');
            ...
            var_init_locked_1568620631620 = true ;
        }
        

                    
        if(!var_class_1568620631620){
 ...
 */
 ...
 function doReorder(node){
    ...
    store.insert(store.indexOf(node) + 1 , childNodes) ;
            ...
            var_class_1568620631620 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1568620631620 ;
                }
...
exports['src::data.store.tree.remove'] = (() =>{
                ...
                let var_init_locked_1568620631631;
...
me.fireEvent('remove' , removeNodes) ;
        ...
        if(!var_init_locked_1568620631631){

            from = include('array.from');

            var_init_locked_1568620631631 = true ;
        }
...
exports['src::data.store.tree'] = (() =>{
                ...
                let var_init_locked_1568620631634;

                let var_class_1568620631634;
        ...
        if(!var_init_locked_1568620631634){
...
isObject = include('is.object.simple');
            ...
            var_init_locked_1568620631634 = true ;
        }
        

                    
        if(!var_class_1568620631634){
...
layout(...args){
            ...
            var_class_1568620631634 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1568620631634 ;
                }
                    ...
                    return new var_class_1568620631634(options);
                } ;
...
exports['src::data.proxy.memory'] = (() =>{
                ...
                let var_init_locked_1568620631635;

                let var_class_1568620631635;
        ...
        if(!var_init_locked_1568620631635){

            Proxy = include('data.proxy')();

            var_init_locked_1568620631635 = true ;
        }
        

                    
        if(!var_class_1568620631635){
 ...
 class main extends Proxy{
    ...
    doRead(data){
        ...
        return data; 
            ...
            var_class_1568620631635 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1568620631635 ;
                }
                    ...
                    return new var_class_1568620631635(options);
                } ;
...
exports['src::canvas.draw.line.bezierCurve'] = (() =>{
                ...
                let var_init_locked_1568620631642;
 ...
 */
 ...
 if(points.length === 8){
    ...
    context.stroke();
        ...
        if(!var_init_locked_1568620631642){

            assign = include('object.assign');

            var_init_locked_1568620631642 = true ;
        }
...
exports['src::browser.event.listeners'] = (() =>{
                ...
                let var_init_locked_1568620631643;

                

                let var_once_value_1568620631643;
...
return map ;
        ...
        if(!var_init_locked_1568620631643){

            map = include('map')();

            var_init_locked_1568620631643 = true ;
        }
        ...
        if(var_once_value_1568620631643){

            return var_once_value_1568620631643 ;

        }
        return var_once_value_1568620631643 = main.call(this ) ;
...
exports['src::browser.selector.parent'] = (() =>{
                ...
                let var_init_locked_1568620631645;
 ...
 */
 ...
 while(el){
    ...
    el = el.parentElement ;
        ...
        if(!var_init_locked_1568620631645){

            is = include('src::browser.selector.is');

            var_init_locked_1568620631645 = true ;
        }
...
exports['src::browser.event.listener.add'] = (() =>{
                ...
                let var_init_locked_1568620631649;
...
add(target , event , listener , {
    once
        ...
        if(!var_init_locked_1568620631649){
...
add = include('event.listener.add');
            ...
            var_init_locked_1568620631649 = true ;
        }
...
exports['src::browser.event.listener.global.add'] = (() =>{
                ...
                let var_init_locked_1568620631650;
 ...
 */
 ...
 add(window , event , fn , config) ;
        ...
        if(!var_init_locked_1568620631650){

            add = include('src::browser.event.listener.add');

            var_init_locked_1568620631650 = true ;
        }
...
exports['src::browser.event.listener.global.remove'] = (() =>{
                ...
                let var_init_locked_1568620631651;
...
remove(window , event , fn) ;
        ...
        if(!var_init_locked_1568620631651){

            remove = include('src::browser.event.listener.remove');

            var_init_locked_1568620631651 = true ;
        }
