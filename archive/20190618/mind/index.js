...
exports['src::is.string'] = (() =>{
                ...
                let var_init_locked_1560848053932;
...
return isType(data , 'string') ;
        ...
        if(!var_init_locked_1560848053932){

            isType = include('is.type');

            var_init_locked_1560848053932 = true ;
        }
...
exports['src::is.class'] = (() =>{
                ...
                let var_init_locked_1560848053934;
...
return isType(data , 'function') && data.ZBEE_CLASS === true ;
        ...
        if(!var_init_locked_1560848053934){

            isType = include('is.type');

            var_init_locked_1560848053934 = true ;
        }
...
exports['src::is.function'] = (() =>{
                ...
                let var_init_locked_1560848053935;
...
return isType(data , 'function') && data.ZBEE_CLASS !== true;
        ...
        if(!var_init_locked_1560848053935){

            isType = include('is.type');

            var_init_locked_1560848053935 = true ;
        }
...
exports['src::class.create'] = (() =>{
                ...
                let var_init_locked_1560848053938;
...
exports['src::class.create.option'] = (() =>{
                ...
                let var_init_locked_1560848053944;
 ...
 */
 ...
 if(isString(option)){
    ...
    return create(namespace) ;
        ...
        if(!var_init_locked_1560848053944){
...
isDefined = include('is.defined');
            ...
            var_init_locked_1560848053944 = true ;
        }
...
exports['src::class.empty'] = (() =>{
                ...
                let var_once_value_1560848053945;
 ...
 */
 ...
 return class {
        ...
        if(var_once_value_1560848053945){

            return var_once_value_1560848053945 ;

        }
        return var_once_value_1560848053945 = main.call(this ) ;
...
exports['src::map.set'] = (() =>{
                ...
                let var_init_locked_1560848053955;

                let var_current_scope_1560848053955;
 ...
 */
 ...
 return me ;
        ...
        if(!var_current_scope_1560848053955 !== this){

            find = include('src::map.find').bind(this);

            var_current_scope_1560848053955 = this ;
        }
...
exports['src::map.get'] = (() =>{
                ...
                let var_init_locked_1560848053956;

                let var_current_scope_1560848053956;
...
if(match){
    ...
    return map.get(key) ;
        ...
        if(!var_current_scope_1560848053956 !== this){

            find = include('src::map.find').bind(this);

            var_current_scope_1560848053956 = this ;
        }
...
exports['src::map.has'] = (() =>{
                ...
                let var_init_locked_1560848053957;

                let var_current_scope_1560848053957;
 ...
 */
 ...
 return match ;
        ...
        if(!var_current_scope_1560848053957 !== this){

            find = include('src::map.find').bind(this);

            var_current_scope_1560848053957 = this ;
        }
...
exports['src::map.delete'] = (() =>{
                ...
                let var_init_locked_1560848053958;

                let var_current_scope_1560848053958;
...
return false ;
        ...
        if(!var_current_scope_1560848053958 !== this){

            find = include('src::map.find').bind(this);

            var_current_scope_1560848053958 = this ;
        }
...
exports['src::map'] = (() =>{
                ...
                let var_init_locked_1560848053962;

                let var_class_1560848053962;
        ...
        if(!var_init_locked_1560848053962){
...
method_clear = include('src::map.clear');
            ...
            var_init_locked_1560848053962 = true ;
        }
        

                    
        if(!var_class_1560848053962){
...
clear(...args){
            ...
            var_class_1560848053962 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1560848053962 ;
                }
                    ...
                    return new var_class_1560848053962();
                } ;
...
exports['src::mixin.observable.constructor'] = (() =>{
                ...
                let var_init_locked_1560848053963;
...
function main(){
    ...
    me.cacheFireEventDataList = [] ;
        ...
        if(!var_init_locked_1560848053963){

            createMap = include('map');

            var_init_locked_1560848053963 = true ;
        }
...
exports['src::mixin.observable.listeners.add'] = (() =>{
                ...
                let var_init_locked_1560848053969;
...
for(let event of events){
    ...
    if(isObject(listener)){
        ...
        if(!var_init_locked_1560848053969){

            isObject = include('is.object.simple');
isFunction = include('is.function');

            var_init_locked_1560848053969 = true ;
        }
...
exports['src::function.get'] = (() =>{
                ...
                let var_init_locked_1560848053974;
...
return empty() ;
        ...
        if(!var_init_locked_1560848053974){

            isString = include('is.string');
isFunction = include('is.function');
empty = include('function.empty');

            var_init_locked_1560848053974 = true ;
        }
...
exports['src::mixin.observable.listener.add'] = (() =>{
                ...
                let var_init_locked_1560848053979;
...
if(once){
     ...
     emitter.addListener(event , listener) ;
        ...
        if(!var_init_locked_1560848053979){

            get = include('function.get');

            var_init_locked_1560848053979 = true ;
        }
...
exports['src::is.array'] = (() =>{
                ...
                let var_init_locked_1560848053982;
 ...
 */
 ...
 return Array.isArray(data) ;
        ...
        if(!var_init_locked_1560848053982){

            isType = include('is.type');

            var_init_locked_1560848053982 = true ;
        }
...
exports['src::mixin.observable.fire'] = (() =>{
                ...
                let var_init_locked_1560848053984;
 ...
 */
 ...
 function doFireBubbleEvent(event , target , ...args){
    ...
    if(bubbleTarget){
        ...
        if(!var_init_locked_1560848053984){

            isArray = include('is.array');

            var_init_locked_1560848053984 = true ;
        }
...
exports['src::mixin.observable'] = (() =>{
                ...
                let var_init_locked_1560848053988;
...
resumeEvents(...args){
        ...
        if(!var_init_locked_1560848053988){
...
method_resumeEvents = include('src::mixin.observable.events.resume');
            ...
            var_init_locked_1560848053988 = true ;
        }
...
exports['src::is.object'] = (() =>{
                ...
                let var_init_locked_1560848053995;
...
return Object.prototype.toString.call(data) === '[object Object]' ;
        ...
        if(!var_init_locked_1560848053995){

            isType = include('is.type');

            var_init_locked_1560848053995 = true ;
        }
...
exports['src::object.value.get'] = (() =>{
                ...
                let var_init_locked_1560848053999;
...
function main(data , key , prefixKey = ''){
    ...
    if(isObject(data)){
        ...
        if(!var_init_locked_1560848053999){
...
join = include('object.key.join');
            ...
            var_init_locked_1560848053999 = true ;
        }
...
exports['src::is.empty'] = (() =>{
                ...
                let var_init_locked_1560848054000;
...
return (data == null) || (!allowEmptyString ? data === '' : false) || (isArray(data) && data.length === 0);
        ...
        if(!var_init_locked_1560848054000){

            isArray = include('is.array');

            var_init_locked_1560848054000 = true ;
        }
...
exports['src::array.from'] = (() =>{
                ...
                let var_init_locked_1560848054002;
...
return [
    data
        ...
        if(!var_init_locked_1560848054002){

            isEmpty = include('is.empty');
isString = include('is.string');

            var_init_locked_1560848054002 = true ;
        }
...
exports['src::data.reader.json'] = (() =>{
                ...
                let var_init_locked_1560848054005;
 ...
 */
 ...
 function generate_get_field_data({
   ...
   return result.join('') ;
        ...
        if(!var_init_locked_1560848054005){
...
getModel = include('data.model.get');
            ...
            var_init_locked_1560848054005 = true ;
        }
...
exports['src::data.proxy.constructor'] = (() =>{
                ...
                let var_init_locked_1560848054006;
...
exports['src::data.proxy.read'] = (() =>{
                ...
                let var_init_locked_1560848054007;
...
function main(options){
    ...
    if(isPromise(data)){
       ...
       data.then(data => fireReadEvent.call(me , data)) ;
        ...
        if(!var_init_locked_1560848054007){

            isPromise = include('is.promise');

            var_init_locked_1560848054007 = true ;
        }
...
exports['src::data.proxy'] = (() =>{
                ...
                let mixin_1560848053776__1,extend,constructor,method_read;

                let var_init_locked_1560848054008;

                let var_class_1560848054008;
        ...
        if(!var_init_locked_1560848054008){

            mixin_1560848053776__1 = include('mixin.observable');
extend = include('class.empty')();
constructor = include('src::data.proxy.constructor');
method_read = include('src::data.proxy.read');

            var_init_locked_1560848054008 = true ;
        }
        

                    
        if(!var_class_1560848054008){
            ...
            var_class_1560848054008 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1560848054008 ;
                }
...
exports['src::data.proxy.memory'] = (() =>{
                ...
                let var_init_locked_1560848054009;

                let var_class_1560848054009;
        ...
        if(!var_init_locked_1560848054009){

            Proxy = include('data.proxy')();

            var_init_locked_1560848054009 = true ;
        }
        

                    
        if(!var_class_1560848054009){
 ...
 class main extends Proxy{
    ...
    doRead(data){
        ...
        return data; 
            ...
            var_class_1560848054009 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1560848054009 ;
                }
                    ...
                    return new var_class_1560848054009(options);
                } ;
...
exports['src::is.proxy.memory'] = (() =>{
                ...
                let var_init_locked_1560848054010;
 ...
 */
 ...
 return data instanceof Proxy && data.proxyType === 'memory' ;
        ...
        if(!var_init_locked_1560848054010){

            Proxy = include('data.proxy')();

            var_init_locked_1560848054010 = true ;
        }
...
exports['src::object.keys'] = (() =>{
                ...
                let var_init_locked_1560848054011;
...
function get_keys(data , rootKey = ''){
    ...
    return result ;
        ...
        if(!var_init_locked_1560848054011){

            isObject = include('is.object.simple');

            var_init_locked_1560848054011 = true ;
        }
...
exports['src::object.value.set'] = (() =>{
                ...
                let var_init_locked_1560848054013;
...
function main(target , key , value){
    ...
    if(splitRe.test(key)){
        ...
        if(!var_init_locked_1560848054013){

            isObject = include('is.object');
split = include('string.split');

            var_init_locked_1560848054013 = true ;
        }
...
exports['src::object.assign.if'] = (() =>{
                ...
                let var_init_locked_1560848054014;
...
function main(dest , ...sources){
    ...
    return dest ;
        ...
        if(!var_init_locked_1560848054014){

            getKeys = include('object.keys');
set = include('object.value.set');
get = include('object.value.get');

            var_init_locked_1560848054014 = true ;
        }
...
exports['src::data.model.base'] = (() =>{
                ...
                let var_init_locked_1560848054015;

                let var_class_1560848054015;
        ...
        if(!var_init_locked_1560848054015){
...
assign2 = include('object.assign.if');
            ...
            var_init_locked_1560848054015 = true ;
        }
        

                    
        if(!var_class_1560848054015){
 ...
 class main{
    ...
    onProxyRead(proxy , records){
        ...
        if(records.length){
            ...
            var_class_1560848054015 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1560848054015 ;
                }
...
exports['src::data.model.fields'] = (() =>{
                ...
                let var_init_locked_1560848054025;
...
class Fields{
 ...
 function getFieldIndex(name){
    ...
    return names.indexOf(name) ;
        ...
        if(!var_init_locked_1560848054025){
...
Store = include('data.store')();
            ...
            var_init_locked_1560848054025 = true ;
        }
...
exports['src::data.model.id'] = (() =>{
                ...
                let var_init_locked_1560848054030;
...
return me.$id = getId('model-') ;
        ...
        if(!var_init_locked_1560848054030){

            getId = include('id.generate');

            var_init_locked_1560848054030 = true ;
        }
...
exports['src::data.model.value.set'] = (() =>{
                ...
                let var_init_locked_1560848054036;
...
if(isObject(values)){
    ...
    return updateValues ;
        ...
        if(!var_init_locked_1560848054036){

            isString = include('is.string');
isObject = include('is.object.simple');

            var_init_locked_1560848054036 = true ;
        }
...
exports['src::data.model'] = (() =>{
                ...
                let mixin_1560848053774__1,extend,static_get_fields,get_isBindStore,get_id,method_bindStore,method_unbindStore,method_has,method_set,method_get,method_load,method_destroy;

                let var_init_locked_1560848054040;

                let var_class_1560848054040;
        ...
        if(!var_init_locked_1560848054040){

            mixin_1560848053774__1 = include('mixin.observable');
...
method_destroy = include('src::data.model.destroy');
            ...
            var_init_locked_1560848054040 = true ;
        }
        

                    
        if(!var_class_1560848054040){
...
get id(){
            ...
            var_class_1560848054040 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1560848054040 ;
                }
...
exports['src::is.class.from'] = (() =>{
                ...
                let var_init_locked_1560848054042;
 ...
 */
 ...
 return isClass(data) && isClass(baseClass) && (data === baseClass || data.prototype instanceof baseClass) ;
        ...
        if(!var_init_locked_1560848054042){

            isClass = include('is.class');
isString = include('is.string');

            var_init_locked_1560848054042 = true ;
        }
...
exports['src::is.data.model.class'] = (() =>{
                ...
                let var_init_locked_1560848054044;
 ...
 */
 ...
 return isClass(data , 'data.model') ;
        ...
        if(!var_init_locked_1560848054044){

            dataModel = include('data.model');
isClass = include('is.class.from');

            var_init_locked_1560848054044 = true ;
        }
...
exports['src::data.model.get'] = (() =>{
                ...
                let var_init_locked_1560848054045;
...
return Model ;
        ...
        if(!var_init_locked_1560848054045){
...
isFunction = include('is.function');
            ...
            var_init_locked_1560848054045 = true ;
        }
...
exports['src::data.model.create'] = (() =>{
                ...
                let var_init_locked_1560848054046;
 ...
 */
 ...
 function main({
    ...
    return define(class extends Model{
        ...
        if(!var_init_locked_1560848054046){

            Model = include('data.model')();
get = include('data.model.get');
define = include('class.define');

            var_init_locked_1560848054046 = true ;
        }
...
exports['src::object.assign'] = (() =>{
                ...
                let var_init_locked_1560848054047;
...
function main(dest , ...sources){
    ...
    return dest ;
        ...
        if(!var_init_locked_1560848054047){

            getKeys = include('object.keys');
set = include('object.value.set');
get = include('object.value.get');

            var_init_locked_1560848054047 = true ;
        }
...
exports['src::array.remove'] = (() =>{
                ...
                let var_init_locked_1560848054048;
 ...
 */
 ...
 for(let item of items){
    ...
    remove(data , data.indexOf(item)) ;
        ...
        if(!var_init_locked_1560848054048){

            remove = include('array.remove.index');

            var_init_locked_1560848054048 = true ;
        }
...
exports['src::is.data.model'] = (() =>{
                ...
                let var_init_locked_1560848054050;
 ...
 */
 ...
 return data instanceof Model ;
        ...
        if(!var_init_locked_1560848054050){

            Model = include('data.model')();

            var_init_locked_1560848054050 = true ;
        }
...
exports['src::data.recordset'] = (() =>{
                ...
                let var_init_locked_1560848054055;

                let var_class_1560848054055;
        ...
        if(!var_init_locked_1560848054055){
...
clone = include('array.clone');
            ...
            var_init_locked_1560848054055 = true ;
        }
        

                    
        if(!var_class_1560848054055){
 ...
 function resetRecordData(recordData){
    ...
    while((index = recordData.indexOf(undefined)) !== -1){
        ...
        removeIndex(recordData , index) ;
            ...
            var_class_1560848054055 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1560848054055 ;
                }
                    ...
                    return new var_class_1560848054055(store);
                } ;
...
exports['src::data.store.base'] = (() =>{
                ...
                let var_init_locked_1560848054056;

                let var_class_1560848054056;
        ...
        if(!var_init_locked_1560848054056){
...
createRecordset = include('data.recordset');
            ...
            var_init_locked_1560848054056 = true ;
        }
        

                    
        if(!var_class_1560848054056){
...
class main{
    ...
    onProxyRead(proxy , records){
        ...
        me.fireEvent('load' , records) ;
            ...
            var_class_1560848054056 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1560848054056 ;
                }
...
exports['src::object.link'] = (() =>{
                ...
                let var_init_locked_1560848054057;
 ...
 */
 ...
 for(let name of names){
    ...
    if(isFunction(value)){
        ...
        if(!var_init_locked_1560848054057){

            isFunction = include('is.function');

            var_init_locked_1560848054057 = true ;
        }
...
exports['src::data.store.constructor'] = (() =>{
                ...
                let var_init_locked_1560848054060;
...
link(me , recordset , [
    ...
    'getById'
        ...
        if(!var_init_locked_1560848054060){
...
link = include('object.link');
            ...
            var_init_locked_1560848054060 = true ;
        }
...
exports['src::data.store.remove'] = (() =>{
                ...
                let var_init_locked_1560848054062;
 ...
 */
 ...
 return records ;
        ...
        if(!var_init_locked_1560848054062){

            remove = include('array.remove');
from = include('array.from');

            var_init_locked_1560848054062 = true ;
        }
...
exports['src::data.store'] = (() =>{
                ...
                let mixin_1560848053754__1,extend,constructor,method_add,method_insert,method_remove,method_load,method_clear;

                let var_init_locked_1560848054064;

                let var_class_1560848054064;
        ...
        if(!var_init_locked_1560848054064){

            mixin_1560848053754__1 = include('mixin.observable');
...
method_clear = include('src::data.store.clear');
            ...
            var_init_locked_1560848054064 = true ;
        }
        

                    
        if(!var_class_1560848054064){
...
clear(...args){
            ...
            var_class_1560848054064 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1560848054064 ;
                }
...
exports['src::data.store.create'] = (() =>{
                ...
                let var_init_locked_1560848054065;
...
return create('data.store' , store) ;
        ...
        if(!var_init_locked_1560848054065){

            create = include('class.create.option');
srcDataStore = include('src::data.store');

            var_init_locked_1560848054065 = true ;
        }
...
exports['src::mixin.region.xy.anchor.set'] = (() =>{
                ...
                let var_init_locked_1560848054070;
...
switch(anchor){
   ...
   case 'b':
       ...
       return assign({
        ...
        if(!var_init_locked_1560848054070){

            isDefined = include('is.defined');

            var_init_locked_1560848054070 = true ;
        }
...
exports['src::mixin.region'] = (() =>{
                ...
                let var_init_locked_1560848054071;
...
exports['src::data.model.node.tree.base'] = (() =>{
                ...
                let var_init_locked_1560848054076;

                let var_class_1560848054076;
        ...
        if(!var_init_locked_1560848054076){
...
isEmpty = include('is.object.empty');
            ...
            var_init_locked_1560848054076 = true ;
        }
        

                    
        if(!var_class_1560848054076){
 ...
 function getChildNode(property){
    ...
    if(children.length){
        ...
        switch(property){
            ...
            var_class_1560848054076 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1560848054076 ;
                }
...
exports['src::math.region'] = (() =>{
                ...
                let var_init_locked_1560848054078;

                let var_class_1560848054078;
        ...
        if(!var_init_locked_1560848054078){

            region = include('mixin.region');

            var_init_locked_1560848054078 = true ;
        }
        

                    
        if(!var_class_1560848054078){
   ...
   containTo(region){
      ...
      return {
         ...
         y:offsetY
            ...
            var_class_1560848054078 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1560848054078 ;
                }
                    ...
                    return new var_class_1560848054078({x , y , width , height});
                } ;
...
exports['src::data.model.node.tree.region'] = (() =>{
                ...
                let var_init_locked_1560848054079;
 ...
 */
 ...
 return createRegion({
     ...
     height
        ...
        if(!var_init_locked_1560848054079){

            createRegion = include('math.region');

            var_init_locked_1560848054079 = true ;
        }
...
exports['src::data.model.node.tree.nodes.descendant'] = (() =>{
                ...
                let var_init_locked_1560848054083;

                let var_current_scope_1560848054083;
...
return result ;
        ...
        if(!var_current_scope_1560848054083 !== this){

            getChildNodes = include('src::data.model.node.tree.nodes.child').bind(this);

            var_current_scope_1560848054083 = this ;
        }
...
exports['src::data.model.node.tree.select.up'] = (() =>{
                ...
                let var_init_locked_1560848054097;

                let var_current_scope_1560848054097;
...
return select('up') ;
        ...
        if(!var_current_scope_1560848054097 !== this){

            select = include('src::data.model.node.tree.select.vertical').bind(this);

            var_current_scope_1560848054097 = this ;
        }
...
exports['src::data.model.node.tree.select.right'] = (() =>{
                ...
                let var_init_locked_1560848054102;
...
if(firstChildNode){
    ...
    if(nearestNode){
        ...
        if(!var_init_locked_1560848054102){

            getDistance = include('math.point.distance');

            var_init_locked_1560848054102 = true ;
        }
...
exports['src::data.model.node.tree'] = (() =>{
                ...
                let mixin_1560848053817__1,extend,get_region,get_depth,get_childCountScopeHeight,get_scopeHeight,get_descendantNodes,get_children,get_lastLeafNode,get_leafNodes,method_layout,method_expand,method_collapse,method_select,method_deselect,method_selectUp,method_selectDown,method_selectLeft,method_selectRight,method_getDepthNodes,method_appendChild,method_insertAfter,method_removeChild;

                let var_init_locked_1560848054110;

                let var_class_1560848054110;
        ...
        if(!var_init_locked_1560848054110){

            mixin_1560848053817__1 = include('mixin.region');
...
method_removeChild = include('src::data.model.node.tree.remove');
            ...
            var_init_locked_1560848054110 = true ;
        }
        

                    
        if(!var_class_1560848054110){
...
get leafNodes(){
            ...
            var_class_1560848054110 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1560848054110 ;
                }
...
exports['src::data.store.tree.base'] = (() =>{
                ...
                let var_init_locked_1560848054112;

                let var_class_1560848054112;
        ...
        if(!var_init_locked_1560848054112){
...
from = include('array.from');
            ...
            var_init_locked_1560848054112 = true ;
        }
        

                    
        if(!var_class_1560848054112){
 ...
 function initNodeVisible(node){
    ...
    if(node.expanded){
        ...
        for(let childNode of childNodes){
            ...
            var_class_1560848054112 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1560848054112 ;
                }
...
exports['src::data.store.tree.remove'] = (() =>{
                ...
                let var_init_locked_1560848054120;
...
me.fireEvent('remove' , removeNodes) ;
        ...
        if(!var_init_locked_1560848054120){

            from = include('array.from');

            var_init_locked_1560848054120 = true ;
        }
...
exports['src::data.store.tree'] = (() =>{
                ...
                let var_init_locked_1560848054123;

                let var_class_1560848054123;
        ...
        if(!var_init_locked_1560848054123){
...
method_layout = include('src::data.store.tree.layout');
            ...
            var_init_locked_1560848054123 = true ;
        }
        

                    
        if(!var_class_1560848054123){
...
layout(...args){
            ...
            var_class_1560848054123 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1560848054123 ;
                }
                    ...
                    return new var_class_1560848054123(options);
                } ;
...
exports['src::browser.global.listener.map'] = (() =>{
                ...
                let var_once_value_1560848054123;
 ...
 */
 ...
 return map ;
        ...
        if(var_once_value_1560848054123){

            return var_once_value_1560848054123 ;

        }
        return var_once_value_1560848054123 = main.call(this ) ;
...
exports['src::browser.selector.parent'] = (() =>{
                ...
                let var_init_locked_1560848054125;
 ...
 */
 ...
 while(el){
    ...
    el = el.parentElement ;
        ...
        if(!var_init_locked_1560848054125){

            is = include('src::browser.selector.is');

            var_init_locked_1560848054125 = true ;
        }
...
exports['src::browser.global.listener.add'] = (() =>{
                ...
                let var_init_locked_1560848054126;
...
exports['src::canvas.draw.line.bezierCurve'] = (() =>{
                ...
                let var_init_locked_1560848054128;
 ...
 */
 ...
 if(points.length === 8){
    ...
    context.stroke();
        ...
        if(!var_init_locked_1560848054128){

            assign = include('object.assign');

            var_init_locked_1560848054128 = true ;
        }
...
exports['src::browser.event.gesture.manager.dom'] = (() =>{
                ...
                let var_init_locked_1560848054129;

                let var_class_1560848054129;

                let var_once_value_1560848054129;

                return function(){

                    
        if(!var_init_locked_1560848054129){

            getName = include('src::browser.event.gesture.name.start');

            var_init_locked_1560848054129 = true ;
        }
        

                    
        if(!var_class_1560848054129){
 ...
 class main {
    ...
    uninstall(el , name){
        ...
        el.removeEventListener(getName(name) , include(`browser.event.${name}.start`)) ;
            ...
            var_class_1560848054129 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1560848054129 ;
                }
        ...
        if(var_once_value_1560848054129){

            return var_once_value_1560848054129 ;

        }

        return var_once_value_1560848054129 = new var_class_1560848054129() ;
