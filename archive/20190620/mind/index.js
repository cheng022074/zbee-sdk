...
exports['src::is.string'] = (() =>{
                ...
                let var_init_locked_1561021859769;
...
return isType(data , 'string') ;
        ...
        if(!var_init_locked_1561021859769){

            isType = include('is.type');

            var_init_locked_1561021859769 = true ;
        }
...
exports['src::is.class'] = (() =>{
                ...
                let var_init_locked_1561021859771;
...
return isType(data , 'function') && data.ZBEE_CLASS === true ;
        ...
        if(!var_init_locked_1561021859771){

            isType = include('is.type');

            var_init_locked_1561021859771 = true ;
        }
...
exports['src::is.function'] = (() =>{
                ...
                let var_init_locked_1561021859772;
...
return isType(data , 'function') && data.ZBEE_CLASS !== true;
        ...
        if(!var_init_locked_1561021859772){

            isType = include('is.type');

            var_init_locked_1561021859772 = true ;
        }
...
exports['src::class.create'] = (() =>{
                ...
                let var_init_locked_1561021859776;
...
exports['src::class.create.option'] = (() =>{
                ...
                let var_init_locked_1561021859781;
 ...
 */
 ...
 if(isString(option)){
    ...
    return create(namespace) ;
        ...
        if(!var_init_locked_1561021859781){
...
isDefined = include('is.defined');
            ...
            var_init_locked_1561021859781 = true ;
        }
...
exports['src::class.empty'] = (() =>{
                ...
                let var_once_value_1561021859782;
 ...
 */
 ...
 return class {
        ...
        if(var_once_value_1561021859782){

            return var_once_value_1561021859782 ;

        }
        return var_once_value_1561021859782 = main.call(this ) ;
...
exports['src::map.set'] = (() =>{
                ...
                let var_init_locked_1561021859790;

                let var_current_scope_1561021859790;
 ...
 */
 ...
 return me ;
        ...
        if(!var_current_scope_1561021859790 !== this){

            find = include('src::map.find').bind(this);

            var_current_scope_1561021859790 = this ;
        }
...
exports['src::map.get'] = (() =>{
                ...
                let var_init_locked_1561021859792;

                let var_current_scope_1561021859792;
...
if(match){
    ...
    return map.get(key) ;
        ...
        if(!var_current_scope_1561021859792 !== this){

            find = include('src::map.find').bind(this);

            var_current_scope_1561021859792 = this ;
        }
...
exports['src::map.delete'] = (() =>{
                ...
                let var_init_locked_1561021859794;

                let var_current_scope_1561021859794;
...
return false ;
        ...
        if(!var_current_scope_1561021859794 !== this){

            find = include('src::map.find').bind(this);

            var_current_scope_1561021859794 = this ;
        }
...
exports['src::map'] = (() =>{
                ...
                let var_init_locked_1561021859798;

                let var_class_1561021859798;
        ...
        if(!var_init_locked_1561021859798){
...
method_clear = include('src::map.clear');
            ...
            var_init_locked_1561021859798 = true ;
        }
        

                    
        if(!var_class_1561021859798){
...
clear(...args){
            ...
            var_class_1561021859798 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1561021859798 ;
                }
                    ...
                    return new var_class_1561021859798();
                } ;
...
exports['src::mixin.observable.constructor'] = (() =>{
                ...
                let var_init_locked_1561021859800;
...
function main(){
    ...
    me.cacheFireEventDataList = [] ;
        ...
        if(!var_init_locked_1561021859800){

            createMap = include('map');

            var_init_locked_1561021859800 = true ;
        }
...
exports['src::mixin.observable.listeners.add'] = (() =>{
                ...
                let var_init_locked_1561021859805;
...
for(let event of events){
    ...
    if(isObject(listener)){
        ...
        if(!var_init_locked_1561021859805){

            isObject = include('is.object.simple');
isFunction = include('is.function');

            var_init_locked_1561021859805 = true ;
        }
...
exports['src::function.get'] = (() =>{
                ...
                let var_init_locked_1561021859811;
...
return empty() ;
        ...
        if(!var_init_locked_1561021859811){

            isString = include('is.string');
isFunction = include('is.function');
empty = include('function.empty');

            var_init_locked_1561021859811 = true ;
        }
...
exports['src::mixin.observable.listener.add'] = (() =>{
                ...
                let var_init_locked_1561021859816;
...
if(once){
     ...
     emitter.addListener(event , listener) ;
        ...
        if(!var_init_locked_1561021859816){

            get = include('function.get');

            var_init_locked_1561021859816 = true ;
        }
...
exports['src::is.array'] = (() =>{
                ...
                let var_init_locked_1561021859820;
 ...
 */
 ...
 return Array.isArray(data) ;
        ...
        if(!var_init_locked_1561021859820){

            isType = include('is.type');

            var_init_locked_1561021859820 = true ;
        }
...
exports['src::mixin.observable.fire'] = (() =>{
                ...
                let var_init_locked_1561021859822;
 ...
 */
 ...
 function doFireBubbleEvent(event , target , ...args){
    ...
    if(bubbleTarget){
        ...
        if(!var_init_locked_1561021859822){

            isArray = include('is.array');

            var_init_locked_1561021859822 = true ;
        }
...
exports['src::mixin.observable'] = (() =>{
                ...
                let var_init_locked_1561021859826;
...
resumeEvents(...args){
        ...
        if(!var_init_locked_1561021859826){
...
method_resumeEvents = include('src::mixin.observable.events.resume');
            ...
            var_init_locked_1561021859826 = true ;
        }
...
exports['src::is.object'] = (() =>{
                ...
                let var_init_locked_1561021859834;
...
return Object.prototype.toString.call(data) === '[object Object]' ;
        ...
        if(!var_init_locked_1561021859834){

            isType = include('is.type');

            var_init_locked_1561021859834 = true ;
        }
...
exports['src::object.value.get'] = (() =>{
                ...
                let var_init_locked_1561021859838;
...
function main(data , key , prefixKey = ''){
    ...
    if(isObject(data)){
        ...
        if(!var_init_locked_1561021859838){
...
join = include('object.key.join');
            ...
            var_init_locked_1561021859838 = true ;
        }
...
exports['src::is.empty'] = (() =>{
                ...
                let var_init_locked_1561021859839;
...
return (data == null) || (!allowEmptyString ? data === '' : false) || (isArray(data) && data.length === 0);
        ...
        if(!var_init_locked_1561021859839){

            isArray = include('is.array');

            var_init_locked_1561021859839 = true ;
        }
...
exports['src::array.from'] = (() =>{
                ...
                let var_init_locked_1561021859840;
...
return [
    data
        ...
        if(!var_init_locked_1561021859840){

            isEmpty = include('is.empty');
isString = include('is.string');

            var_init_locked_1561021859840 = true ;
        }
...
exports['src::data.reader.json'] = (() =>{
                ...
                let var_init_locked_1561021859842;
 ...
 */
 ...
 function generate_get_field_data({
   ...
   return result.join('') ;
        ...
        if(!var_init_locked_1561021859842){
...
getModel = include('data.model.get');
            ...
            var_init_locked_1561021859842 = true ;
        }
...
exports['src::data.proxy.constructor'] = (() =>{
                ...
                let var_init_locked_1561021859843;
...
exports['src::data.proxy.read'] = (() =>{
                ...
                let var_init_locked_1561021859844;
...
function main(options){
    ...
    if(isPromise(data)){
       ...
       data.then(data => fireReadEvent.call(me , data)) ;
        ...
        if(!var_init_locked_1561021859844){

            isPromise = include('is.promise');

            var_init_locked_1561021859844 = true ;
        }
...
exports['src::data.proxy'] = (() =>{
                ...
                let mixin_1561021859568__1,extend,constructor,method_read;

                let var_init_locked_1561021859846;

                let var_class_1561021859846;
        ...
        if(!var_init_locked_1561021859846){

            mixin_1561021859568__1 = include('mixin.observable');
extend = include('class.empty')();
constructor = include('src::data.proxy.constructor');
method_read = include('src::data.proxy.read');

            var_init_locked_1561021859846 = true ;
        }
        

                    
        if(!var_class_1561021859846){
            ...
            var_class_1561021859846 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1561021859846 ;
                }
...
exports['src::data.proxy.memory'] = (() =>{
                ...
                let var_init_locked_1561021859847;

                let var_class_1561021859847;
        ...
        if(!var_init_locked_1561021859847){

            Proxy = include('data.proxy')();

            var_init_locked_1561021859847 = true ;
        }
        

                    
        if(!var_class_1561021859847){
 ...
 class main extends Proxy{
    ...
    doRead(data){
        ...
        return data; 
            ...
            var_class_1561021859847 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1561021859847 ;
                }
                    ...
                    return new var_class_1561021859847(options);
                } ;
...
exports['src::is.proxy.memory'] = (() =>{
                ...
                let var_init_locked_1561021859848;
 ...
 */
 ...
 return data instanceof Proxy && data.proxyType === 'memory' ;
        ...
        if(!var_init_locked_1561021859848){

            Proxy = include('data.proxy')();

            var_init_locked_1561021859848 = true ;
        }
...
exports['src::object.keys'] = (() =>{
                ...
                let var_init_locked_1561021859849;
...
function get_keys(data , rootKey = ''){
    ...
    return result ;
        ...
        if(!var_init_locked_1561021859849){

            isObject = include('is.object.simple');

            var_init_locked_1561021859849 = true ;
        }
...
exports['src::object.value.set'] = (() =>{
                ...
                let var_init_locked_1561021859850;
...
function main(target , key , value){
    ...
    if(splitRe.test(key)){
        ...
        if(!var_init_locked_1561021859850){

            isObject = include('is.object');
split = include('string.split');

            var_init_locked_1561021859850 = true ;
        }
...
exports['src::object.assign.if'] = (() =>{
                ...
                let var_init_locked_1561021859851;
...
function main(dest , ...sources){
    ...
    return dest ;
        ...
        if(!var_init_locked_1561021859851){

            getKeys = include('object.keys');
set = include('object.value.set');
get = include('object.value.get');

            var_init_locked_1561021859851 = true ;
        }
...
exports['src::data.model.base'] = (() =>{
                ...
                let var_init_locked_1561021859853;

                let var_class_1561021859853;
        ...
        if(!var_init_locked_1561021859853){
...
assign2 = include('object.assign.if');
            ...
            var_init_locked_1561021859853 = true ;
        }
        

                    
        if(!var_class_1561021859853){
 ...
 class main{
    ...
    onProxyRead(proxy , records){
        ...
        if(records.length){
            ...
            var_class_1561021859853 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1561021859853 ;
                }
...
exports['src::data.model.fields'] = (() =>{
                ...
                let var_init_locked_1561021859861;
...
class Fields{
 ...
 function getFieldIndex(name){
    ...
    return names.indexOf(name) ;
        ...
        if(!var_init_locked_1561021859861){
...
Store = include('data.store')();
            ...
            var_init_locked_1561021859861 = true ;
        }
...
exports['src::data.model.id'] = (() =>{
                ...
                let var_init_locked_1561021859864;
...
return me.$id = getId('model-') ;
        ...
        if(!var_init_locked_1561021859864){

            getId = include('id.generate');

            var_init_locked_1561021859864 = true ;
        }
...
exports['src::data.model.value.set'] = (() =>{
                ...
                let var_init_locked_1561021859868;
...
if(isObject(values)){
    ...
    return updateValues ;
        ...
        if(!var_init_locked_1561021859868){

            isString = include('is.string');
isObject = include('is.object.simple');

            var_init_locked_1561021859868 = true ;
        }
...
exports['src::data.model'] = (() =>{
                ...
                let mixin_1561021859564__1,extend,static_get_fields,get_isBindStore,get_id,method_bindStore,method_unbindStore,method_has,method_set,method_get,method_load,method_destroy;

                let var_init_locked_1561021859872;

                let var_class_1561021859872;
        ...
        if(!var_init_locked_1561021859872){

            mixin_1561021859564__1 = include('mixin.observable');
...
method_destroy = include('src::data.model.destroy');
            ...
            var_init_locked_1561021859872 = true ;
        }
        

                    
        if(!var_class_1561021859872){
...
get id(){
            ...
            var_class_1561021859872 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1561021859872 ;
                }
...
exports['src::is.class.from'] = (() =>{
                ...
                let var_init_locked_1561021859873;
 ...
 */
 ...
 return isClass(data) && isClass(baseClass) && (data === baseClass || data.prototype instanceof baseClass) ;
        ...
        if(!var_init_locked_1561021859873){

            isClass = include('is.class');
isString = include('is.string');

            var_init_locked_1561021859873 = true ;
        }
...
exports['src::is.data.model.class'] = (() =>{
                ...
                let var_init_locked_1561021859874;
 ...
 */
 ...
 return isClass(data , 'data.model') ;
        ...
        if(!var_init_locked_1561021859874){

            dataModel = include('data.model');
isClass = include('is.class.from');

            var_init_locked_1561021859874 = true ;
        }
...
exports['src::data.model.get'] = (() =>{
                ...
                let var_init_locked_1561021859876;
...
return Model ;
        ...
        if(!var_init_locked_1561021859876){
...
isFunction = include('is.function');
            ...
            var_init_locked_1561021859876 = true ;
        }
...
exports['src::data.model.create'] = (() =>{
                ...
                let var_init_locked_1561021859878;
 ...
 */
 ...
 function main({
    ...
    return define(class extends Model{
        ...
        if(!var_init_locked_1561021859878){

            Model = include('data.model')();
get = include('data.model.get');
define = include('class.define');

            var_init_locked_1561021859878 = true ;
        }
...
exports['src::array.remove'] = (() =>{
                ...
                let var_init_locked_1561021859880;
 ...
 */
 ...
 for(let item of items){
    ...
    remove(data , data.indexOf(item)) ;
        ...
        if(!var_init_locked_1561021859880){

            remove = include('array.remove.index');

            var_init_locked_1561021859880 = true ;
        }
...
exports['src::is.data.model'] = (() =>{
                ...
                let var_init_locked_1561021859882;
 ...
 */
 ...
 return data instanceof Model ;
        ...
        if(!var_init_locked_1561021859882){

            Model = include('data.model')();

            var_init_locked_1561021859882 = true ;
        }
...
exports['src::data.recordset'] = (() =>{
                ...
                let var_init_locked_1561021859889;

                let var_class_1561021859889;
        ...
        if(!var_init_locked_1561021859889){
...
clone = include('array.clone');
            ...
            var_init_locked_1561021859889 = true ;
        }
        

                    
        if(!var_class_1561021859889){
 ...
 function resetRecordData(recordData){
    ...
    while((index = recordData.indexOf(undefined)) !== -1){
        ...
        removeIndex(recordData , index) ;
            ...
            var_class_1561021859889 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1561021859889 ;
                }
                    ...
                    return new var_class_1561021859889(store);
                } ;
...
exports['src::object.link'] = (() =>{
                ...
                let var_init_locked_1561021859891;
 ...
 */
 ...
 for(let name of names){
    ...
    if(isFunction(value)){
        ...
        if(!var_init_locked_1561021859891){

            isFunction = include('is.function');

            var_init_locked_1561021859891 = true ;
        }
...
exports['src::data.store.constructor'] = (() =>{
                ...
                let var_init_locked_1561021859894;
...
link(me , recordset , [
    ...
    'getById'
        ...
        if(!var_init_locked_1561021859894){
...
link = include('object.link');
            ...
            var_init_locked_1561021859894 = true ;
        }
...
exports['src::data.store.remove'] = (() =>{
                ...
                let var_init_locked_1561021859897;
 ...
 */
 ...
 return records ;
        ...
        if(!var_init_locked_1561021859897){

            remove = include('array.remove');
from = include('array.from');

            var_init_locked_1561021859897 = true ;
        }
...
exports['src::data.store'] = (() =>{
                ...
                let mixin_1561021859538__1,extend,constructor,method_add,method_insert,method_remove,method_load,method_clear;

                let var_init_locked_1561021859900;

                let var_class_1561021859900;
        ...
        if(!var_init_locked_1561021859900){

            mixin_1561021859538__1 = include('mixin.observable');
...
method_clear = include('src::data.store.clear');
            ...
            var_init_locked_1561021859900 = true ;
        }
        

                    
        if(!var_class_1561021859900){
...
clear(...args){
            ...
            var_class_1561021859900 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1561021859900 ;
                }
...
exports['src::data.store.create'] = (() =>{
                ...
                let var_init_locked_1561021859901;
...
return create('data.store' , store) ;
        ...
        if(!var_init_locked_1561021859901){

            create = include('class.create.option');
srcDataStore = include('src::data.store');

            var_init_locked_1561021859901 = true ;
        }
...
exports['src::mixin.region.xy.anchor.set'] = (() =>{
                ...
                let var_init_locked_1561021859906;
...
switch(anchor){
   ...
   case 'b':
       ...
       return assign({
        ...
        if(!var_init_locked_1561021859906){

            isDefined = include('is.defined');

            var_init_locked_1561021859906 = true ;
        }
...
exports['src::mixin.region'] = (() =>{
                ...
                let var_init_locked_1561021859907;
...
exports['src::data.model.node.tree.base'] = (() =>{
                ...
                let var_init_locked_1561021859914;

                let var_class_1561021859914;
        ...
        if(!var_init_locked_1561021859914){
...
isEmpty = include('is.object.empty');
            ...
            var_init_locked_1561021859914 = true ;
        }
        

                    
        if(!var_class_1561021859914){
 ...
 function getChildNode(property){
    ...
    if(children.length){
        ...
        switch(property){
            ...
            var_class_1561021859914 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1561021859914 ;
                }
...
exports['src::math.region'] = (() =>{
                ...
                let var_init_locked_1561021859917;

                let var_class_1561021859917;
        ...
        if(!var_init_locked_1561021859917){

            region = include('mixin.region');

            var_init_locked_1561021859917 = true ;
        }
        

                    
        if(!var_class_1561021859917){
   ...
   containTo(region){
      ...
      return {
         ...
         y:offsetY
            ...
            var_class_1561021859917 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1561021859917 ;
                }
                    ...
                    return new var_class_1561021859917({x , y , width , height});
                } ;
...
exports['src::data.model.node.tree.nodes.descendant'] = (() =>{
                ...
                let var_init_locked_1561021859923;

                let var_current_scope_1561021859923;
...
return result ;
        ...
        if(!var_current_scope_1561021859923 !== this){

            getChildNodes = include('src::data.model.node.tree.nodes.child').bind(this);

            var_current_scope_1561021859923 = this ;
        }
...
exports['src::data.model.node.tree.select.up'] = (() =>{
                ...
                let var_init_locked_1561021859938;

                let var_current_scope_1561021859938;
...
return select('up') ;
        ...
        if(!var_current_scope_1561021859938 !== this){

            select = include('src::data.model.node.tree.select.vertical').bind(this);

            var_current_scope_1561021859938 = this ;
        }
...
exports['src::data.model.node.tree.select.down'] = (() =>{
                ...
                let var_init_locked_1561021859939;

                let var_current_scope_1561021859939;
 ...
 */
 ...
 return select('down') ;
        ...
        if(!var_current_scope_1561021859939 !== this){

            select = include('src::data.model.node.tree.select.vertical').bind(this);

            var_current_scope_1561021859939 = this ;
        }
...
exports['src::data.model.node.tree.select.right'] = (() =>{
                ...
                let var_init_locked_1561021859945;
...
if(firstChildNode){
    ...
    if(nearestNode){
        ...
        if(!var_init_locked_1561021859945){

            getDistance = include('math.point.distance');

            var_init_locked_1561021859945 = true ;
        }
...
exports['src::data.model.node.tree'] = (() =>{
        ...
        if(!var_init_locked_1561021859959){

            mixin_1561021859627__1 = include('mixin.region');
...
method_removeChild = include('src::data.model.node.tree.remove');
            ...
            var_init_locked_1561021859959 = true ;
        }
        

                    
        if(!var_class_1561021859959){
...
get leafNodes(){
            ...
            var_class_1561021859959 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1561021859959 ;
                }
...
exports['src::data.store.tree.base'] = (() =>{
                ...
                let var_init_locked_1561021859961;

                let var_class_1561021859961;
        ...
        if(!var_init_locked_1561021859961){
...
from = include('array.from');
            ...
            var_init_locked_1561021859961 = true ;
        }
        

                    
        if(!var_class_1561021859961){
 ...
 */
 ...
 function doReorder(node){
    ...
    store.insert(store.indexOf(node) + 1 , childNodes) ;
            ...
            var_class_1561021859961 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1561021859961 ;
                }
...
exports['src::data.store.tree.remove'] = (() =>{
                ...
                let var_init_locked_1561021859966;
...
me.fireEvent('remove' , removeNodes) ;
        ...
        if(!var_init_locked_1561021859966){

            from = include('array.from');

            var_init_locked_1561021859966 = true ;
        }
...
exports['src::data.store.tree'] = (() =>{
                ...
                let var_init_locked_1561021859968;

                let var_class_1561021859968;
        ...
        if(!var_init_locked_1561021859968){
...
method_layout = include('src::data.store.tree.layout');
            ...
            var_init_locked_1561021859968 = true ;
        }
        

                    
        if(!var_class_1561021859968){
...
layout(...args){
            ...
            var_class_1561021859968 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1561021859968 ;
                }
                    ...
                    return new var_class_1561021859968(options);
                } ;
...
exports['src::browser.global.listener.map'] = (() =>{
                ...
                let var_once_value_1561021859968;
 ...
 */
 ...
 return map ;
        ...
        if(var_once_value_1561021859968){

            return var_once_value_1561021859968 ;

        }
        return var_once_value_1561021859968 = main.call(this ) ;
...
exports['src::browser.selector.parent'] = (() =>{
                ...
                let var_init_locked_1561021859970;
 ...
 */
 ...
 while(el){
    ...
    el = el.parentElement ;
        ...
        if(!var_init_locked_1561021859970){

            is = include('src::browser.selector.is');

            var_init_locked_1561021859970 = true ;
        }
...
exports['src::browser.global.listener.add'] = (() =>{
                ...
                let var_init_locked_1561021859971;
...
exports['src::browser.global.listener.remove'] = (() =>{
                ...
                let var_init_locked_1561021859972;
...
if(listenerFn){
    ...
    window.removeEventListener(event , listenerFn) ;
        ...
        if(!var_init_locked_1561021859972){

            getMap = include('src::browser.global.listener.map');

            var_init_locked_1561021859972 = true ;
        }
...
exports['src::canvas.draw.line.bezierCurve'] = (() =>{
                ...
                let var_init_locked_1561021859975;
 ...
 */
 ...
 if(points.length === 8){
    ...
    context.stroke();
        ...
        if(!var_init_locked_1561021859975){

            assign = include('object.assign');

            var_init_locked_1561021859975 = true ;
        }
...
exports['src::is.browser.support.pointer'] = (() =>{
                ...
                let var_once_value_1561021859980;
...
return window.hasOwnProperty('onpointerdown');
        ...
        if(var_once_value_1561021859980){

            return var_once_value_1561021859980 ;

        }
        return var_once_value_1561021859980 = main.call(this ) ;
...
exports['src::browser.event.name.single'] = (() =>{
                ...
                let var_init_locked_1561021859982;
...
exports['src::os.name'] = (() =>{
                ...
                let var_once_value_1561021859983;
...
return name ;
        ...
        if(var_once_value_1561021859983){

            return var_once_value_1561021859983 ;

        }
        return var_once_value_1561021859983 = main.call(this ) ;
...
exports['src::browser.scale'] = (() =>{
                ...
                let var_init_locked_1561021859984;
...
return window.devicePixelRatio ;
        ...
        if(!var_init_locked_1561021859984){

            osName = include('os.name');

            var_init_locked_1561021859984 = true ;
        }
...
exports['config::event.tap'] = (() =>{
                ...
                let var_init_locked_1561021859985;
    ...
    "moveDistance":8
        ...
        if(!var_init_locked_1561021859985){

            get = include('object.value.get');

            var_init_locked_1561021859985 = true ;
        }
...
exports['src::browser.event.gesture.tap.move'] = (() =>{
                ...
                let var_init_locked_1561021859986;
...
if(Math.round(getDistance({
    ...
    disabled() ;
        ...
        if(!var_init_locked_1561021859986){
...
moveDistance = config('event.tap' , 'moveDistance');
            ...
            var_init_locked_1561021859986 = true ;
        }
...
exports['src::browser.event.gesture.tap.disabled'] = (() =>{
                ...
                let var_init_locked_1561021859987;
...
exports['src::browser.event.gesture.tap.end'] = (() =>{
                ...
                let var_init_locked_1561021859988;

                let var_current_scope_1561021859988;
 ...
 */
 ...
 disabled() ;
        ...
        if(!var_init_locked_1561021859988){

            stop = include('browser.event.stop');

            var_init_locked_1561021859988 = true ;
        }
        

                    
        if(!var_current_scope_1561021859988 !== this){

            disabled = include('src::browser.event.gesture.tap.disabled').bind(this);
dispatch = include('browser.event.dispatch').bind(this);

            var_current_scope_1561021859988 = this ;
        }
...
exports['src::browser.event.gesture.tap.start.global'] = (() =>{
                ...
                let var_init_locked_1561021859989;

                let var_current_scope_1561021859989;
 ...
 */
 ...
 if(getTouchEvents(e)){
    ...
    disabled() ;
        ...
        if(!var_init_locked_1561021859989){

            getTouchEvents = include('browser.event.touches');
stop = include('browser.event.stop');

            var_init_locked_1561021859989 = true ;
        }
        

                    
        if(!var_current_scope_1561021859989 !== this){

            disabled = include('src::browser.event.gesture.tap.start.disabled').bind(this);

            var_current_scope_1561021859989 = this ;
        }
...
exports['src::browser.event.gesture.tap.enabled'] = (() =>{
                ...
                let var_init_locked_1561021859990;

                let var_current_scope_1561021859990;
 ...
 */
 ...
 on(getName('end') , me.onEnd = onEnd) ;
        ...
        if(!var_init_locked_1561021859990){

            getName = include('browser.event.name.single');
on = include('browser.global.listener.add');

            var_init_locked_1561021859990 = true ;
        }
        

                    
        if(!var_current_scope_1561021859990 !== this){
...
onStart = include('src::browser.event.gesture.tap.start.global').bind(this);
            ...
            var_current_scope_1561021859990 = this ;
        }
...
exports['src::browser.event.gesture.tap.start'] = (() =>{
                ...
                let var_init_locked_1561021859991;

                let var_current_scope_1561021859991;
...
enabled() ;
        ...
        if(!var_init_locked_1561021859991){
...
timeout = config('event.tap' , 'timeout');
            ...
            var_init_locked_1561021859991 = true ;
        }
        

                    
        if(!var_current_scope_1561021859991 !== this){

            enabled = include('src::browser.event.gesture.tap.enabled').bind(this);
disabled = include('src::browser.event.gesture.tap.disabled').bind(this);

            var_current_scope_1561021859991 = this ;
        }
...
exports['src::browser.event.gesture.manager.dom'] = (() =>{
                ...
                let var_init_locked_1561021859992;

                let var_class_1561021859992;

                let var_once_value_1561021859992;

                return function(){

                    
        if(!var_init_locked_1561021859992){

            getName = include('src::browser.event.gesture.name.start');
createMap = include('map');

            var_init_locked_1561021859992 = true ;
        }
        

                    
        if(!var_class_1561021859992){
 ...
 class main {
    ...
    uninstall(el , name){
        ...
        if(listener){
            ...
            var_class_1561021859992 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1561021859992 ;
                }
        ...
        if(var_once_value_1561021859992){

            return var_once_value_1561021859992 ;

        }

        return var_once_value_1561021859992 = new var_class_1561021859992() ;
