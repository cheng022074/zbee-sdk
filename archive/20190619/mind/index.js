...
exports['src::is.string'] = (() =>{
                ...
                let var_init_locked_1560908651329;
...
return isType(data , 'string') ;
        ...
        if(!var_init_locked_1560908651329){

            isType = include('is.type');

            var_init_locked_1560908651329 = true ;
        }
...
exports['src::is.class'] = (() =>{
                ...
                let var_init_locked_1560908651331;
...
return isType(data , 'function') && data.ZBEE_CLASS === true ;
        ...
        if(!var_init_locked_1560908651331){

            isType = include('is.type');

            var_init_locked_1560908651331 = true ;
        }
...
exports['src::class.create'] = (() =>{
                ...
                let var_init_locked_1560908651335;
...
exports['src::class.create.option'] = (() =>{
                ...
                let var_init_locked_1560908651340;
 ...
 */
 ...
 if(isString(option)){
    ...
    return create(namespace) ;
        ...
        if(!var_init_locked_1560908651340){
...
isDefined = include('is.defined');
            ...
            var_init_locked_1560908651340 = true ;
        }
...
exports['src::class.empty'] = (() =>{
                ...
                let var_once_value_1560908651341;
 ...
 */
 ...
 return class {
        ...
        if(var_once_value_1560908651341){

            return var_once_value_1560908651341 ;

        }
        return var_once_value_1560908651341 = main.call(this ) ;
...
exports['src::map.set'] = (() =>{
                ...
                let var_init_locked_1560908651350;

                let var_current_scope_1560908651350;
 ...
 */
 ...
 return me ;
        ...
        if(!var_current_scope_1560908651350 !== this){

            find = include('src::map.find').bind(this);

            var_current_scope_1560908651350 = this ;
        }
...
exports['src::map.get'] = (() =>{
                ...
                let var_init_locked_1560908651351;

                let var_current_scope_1560908651351;
...
if(match){
    ...
    return map.get(key) ;
        ...
        if(!var_current_scope_1560908651351 !== this){

            find = include('src::map.find').bind(this);

            var_current_scope_1560908651351 = this ;
        }
...
exports['src::map.has'] = (() =>{
                ...
                let var_init_locked_1560908651352;

                let var_current_scope_1560908651352;
 ...
 */
 ...
 return match ;
        ...
        if(!var_current_scope_1560908651352 !== this){

            find = include('src::map.find').bind(this);

            var_current_scope_1560908651352 = this ;
        }
...
exports['src::map.delete'] = (() =>{
                ...
                let var_init_locked_1560908651353;

                let var_current_scope_1560908651353;
...
return false ;
        ...
        if(!var_current_scope_1560908651353 !== this){

            find = include('src::map.find').bind(this);

            var_current_scope_1560908651353 = this ;
        }
...
exports['src::map'] = (() =>{
                ...
                let var_init_locked_1560908651357;

                let var_class_1560908651357;
        ...
        if(!var_init_locked_1560908651357){
...
method_clear = include('src::map.clear');
            ...
            var_init_locked_1560908651357 = true ;
        }
        

                    
        if(!var_class_1560908651357){
...
clear(...args){
            ...
            var_class_1560908651357 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1560908651357 ;
                }
                    ...
                    return new var_class_1560908651357();
                } ;
...
exports['src::mixin.observable.constructor'] = (() =>{
                ...
                let var_init_locked_1560908651358;
...
function main(){
    ...
    me.cacheFireEventDataList = [] ;
        ...
        if(!var_init_locked_1560908651358){

            createMap = include('map');

            var_init_locked_1560908651358 = true ;
        }
...
exports['src::mixin.observable.listeners.add'] = (() =>{
                ...
                let var_init_locked_1560908651363;
...
for(let event of events){
    ...
    if(isObject(listener)){
        ...
        if(!var_init_locked_1560908651363){

            isObject = include('is.object.simple');
isFunction = include('is.function');

            var_init_locked_1560908651363 = true ;
        }
...
exports['src::function.get'] = (() =>{
                ...
                let var_init_locked_1560908651369;
...
return empty() ;
        ...
        if(!var_init_locked_1560908651369){

            isString = include('is.string');
isFunction = include('is.function');
empty = include('function.empty');

            var_init_locked_1560908651369 = true ;
        }
...
exports['src::mixin.observable.listener.add'] = (() =>{
                ...
                let var_init_locked_1560908651374;
...
if(once){
     ...
     emitter.addListener(event , listener) ;
        ...
        if(!var_init_locked_1560908651374){

            get = include('function.get');

            var_init_locked_1560908651374 = true ;
        }
...
exports['src::is.array'] = (() =>{
                ...
                let var_init_locked_1560908651378;
 ...
 */
 ...
 return Array.isArray(data) ;
        ...
        if(!var_init_locked_1560908651378){

            isType = include('is.type');

            var_init_locked_1560908651378 = true ;
        }
...
exports['src::mixin.observable.fire'] = (() =>{
                ...
                let var_init_locked_1560908651380;
 ...
 */
 ...
 function doFireBubbleEvent(event , target , ...args){
    ...
    if(bubbleTarget){
        ...
        if(!var_init_locked_1560908651380){

            isArray = include('is.array');

            var_init_locked_1560908651380 = true ;
        }
...
exports['src::mixin.observable'] = (() =>{
                ...
                let var_init_locked_1560908651384;
...
resumeEvents(...args){
        ...
        if(!var_init_locked_1560908651384){
...
method_resumeEvents = include('src::mixin.observable.events.resume');
            ...
            var_init_locked_1560908651384 = true ;
        }
...
exports['src::is.object'] = (() =>{
                ...
                let var_init_locked_1560908651390;
...
return Object.prototype.toString.call(data) === '[object Object]' ;
        ...
        if(!var_init_locked_1560908651390){

            isType = include('is.type');

            var_init_locked_1560908651390 = true ;
        }
...
exports['src::object.value.get'] = (() =>{
                ...
                let var_init_locked_1560908651393;
...
function main(data , key , prefixKey = ''){
    ...
    if(isObject(data)){
        ...
        if(!var_init_locked_1560908651393){
...
join = include('object.key.join');
            ...
            var_init_locked_1560908651393 = true ;
        }
...
exports['src::array.from'] = (() =>{
                ...
                let var_init_locked_1560908651396;
...
return [
    data
        ...
        if(!var_init_locked_1560908651396){

            isEmpty = include('is.empty');
isString = include('is.string');

            var_init_locked_1560908651396 = true ;
        }
...
exports['src::data.reader.json'] = (() =>{
                ...
                let var_init_locked_1560908651399;
 ...
 */
 ...
 function generate_get_field_data({
   ...
   return result.join('') ;
        ...
        if(!var_init_locked_1560908651399){
...
getModel = include('data.model.get');
            ...
            var_init_locked_1560908651399 = true ;
        }
...
exports['src::data.proxy.constructor'] = (() =>{
                ...
                let var_init_locked_1560908651401;
...
exports['src::data.proxy.read'] = (() =>{
                ...
                let var_init_locked_1560908651402;
...
function main(options){
    ...
    if(isPromise(data)){
       ...
       data.then(data => fireReadEvent.call(me , data)) ;
        ...
        if(!var_init_locked_1560908651402){

            isPromise = include('is.promise');

            var_init_locked_1560908651402 = true ;
        }
...
exports['src::data.proxy'] = (() =>{
                ...
                let mixin_1560908651157__1,extend,constructor,method_read;

                let var_init_locked_1560908651404;

                let var_class_1560908651404;
        ...
        if(!var_init_locked_1560908651404){

            mixin_1560908651157__1 = include('mixin.observable');
extend = include('class.empty')();
constructor = include('src::data.proxy.constructor');
method_read = include('src::data.proxy.read');

            var_init_locked_1560908651404 = true ;
        }
        

                    
        if(!var_class_1560908651404){
            ...
            var_class_1560908651404 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1560908651404 ;
                }
...
exports['src::data.proxy.memory'] = (() =>{
                ...
                let var_init_locked_1560908651405;

                let var_class_1560908651405;
        ...
        if(!var_init_locked_1560908651405){

            Proxy = include('data.proxy')();

            var_init_locked_1560908651405 = true ;
        }
        

                    
        if(!var_class_1560908651405){
 ...
 class main extends Proxy{
    ...
    doRead(data){
        ...
        return data; 
            ...
            var_class_1560908651405 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1560908651405 ;
                }
                    ...
                    return new var_class_1560908651405(options);
                } ;
...
exports['src::is.proxy.memory'] = (() =>{
                ...
                let var_init_locked_1560908651406;
 ...
 */
 ...
 return data instanceof Proxy && data.proxyType === 'memory' ;
        ...
        if(!var_init_locked_1560908651406){

            Proxy = include('data.proxy')();

            var_init_locked_1560908651406 = true ;
        }
...
exports['src::object.keys'] = (() =>{
                ...
                let var_init_locked_1560908651407;
...
function get_keys(data , rootKey = ''){
    ...
    return result ;
        ...
        if(!var_init_locked_1560908651407){

            isObject = include('is.object.simple');

            var_init_locked_1560908651407 = true ;
        }
...
exports['src::string.split'] = (() =>{
                ...
                let var_init_locked_1560908651408;
...
function main(target , splitRe){
 ...
 function filter(target){
    ...
    return !isEmpty(target) ;
        ...
        if(!var_init_locked_1560908651408){

            isEmpty = include('is.empty');

            var_init_locked_1560908651408 = true ;
        }
...
exports['src::object.assign.if'] = (() =>{
                ...
                let var_init_locked_1560908651409;
...
function main(dest , ...sources){
    ...
    return dest ;
        ...
        if(!var_init_locked_1560908651409){

            getKeys = include('object.keys');
set = include('object.value.set');
get = include('object.value.get');

            var_init_locked_1560908651409 = true ;
        }
...
exports['src::data.model.base'] = (() =>{
                ...
                let var_init_locked_1560908651412;

                let var_class_1560908651412;
        ...
        if(!var_init_locked_1560908651412){
...
assign2 = include('object.assign.if');
            ...
            var_init_locked_1560908651412 = true ;
        }
        

                    
        if(!var_class_1560908651412){
 ...
 class main{
    ...
    onProxyRead(proxy , records){
        ...
        if(records.length){
            ...
            var_class_1560908651412 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1560908651412 ;
                }
...
exports['src::data.model.fields'] = (() =>{
                ...
                let var_init_locked_1560908651420;
...
class Fields{
 ...
 function getFieldIndex(name){
    ...
    return names.indexOf(name) ;
        ...
        if(!var_init_locked_1560908651420){
...
Store = include('data.store')();
            ...
            var_init_locked_1560908651420 = true ;
        }
...
exports['src::data.model.id'] = (() =>{
                ...
                let var_init_locked_1560908651425;
...
return me.$id = getId('model-') ;
        ...
        if(!var_init_locked_1560908651425){

            getId = include('id.generate');

            var_init_locked_1560908651425 = true ;
        }
...
exports['src::data.model.value.set'] = (() =>{
                ...
                let var_init_locked_1560908651429;
...
if(isObject(values)){
    ...
    return updateValues ;
        ...
        if(!var_init_locked_1560908651429){

            isString = include('is.string');
isObject = include('is.object.simple');

            var_init_locked_1560908651429 = true ;
        }
...
exports['src::data.model'] = (() =>{
                ...
                let mixin_1560908651154__1,extend,static_get_fields,get_isBindStore,get_id,method_bindStore,method_unbindStore,method_has,method_set,method_get,method_load,method_destroy;

                let var_init_locked_1560908651432;

                let var_class_1560908651432;
        ...
        if(!var_init_locked_1560908651432){

            mixin_1560908651154__1 = include('mixin.observable');
...
method_destroy = include('src::data.model.destroy');
            ...
            var_init_locked_1560908651432 = true ;
        }
        

                    
        if(!var_class_1560908651432){
...
get id(){
            ...
            var_class_1560908651432 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1560908651432 ;
                }
...
exports['src::is.class.from'] = (() =>{
                ...
                let var_init_locked_1560908651433;
 ...
 */
 ...
 return isClass(data) && isClass(baseClass) && (data === baseClass || data.prototype instanceof baseClass) ;
        ...
        if(!var_init_locked_1560908651433){

            isClass = include('is.class');
isString = include('is.string');

            var_init_locked_1560908651433 = true ;
        }
...
exports['src::data.model.get'] = (() =>{
                ...
                let var_init_locked_1560908651434;
...
return Model ;
        ...
        if(!var_init_locked_1560908651434){
...
isFunction = include('is.function');
            ...
            var_init_locked_1560908651434 = true ;
        }
...
exports['src::data.model.create'] = (() =>{
                ...
                let var_init_locked_1560908651435;
 ...
 */
 ...
 function main({
    ...
    return define(class extends Model{
        ...
        if(!var_init_locked_1560908651435){

            Model = include('data.model')();
get = include('data.model.get');
define = include('class.define');

            var_init_locked_1560908651435 = true ;
        }
...
exports['src::object.assign'] = (() =>{
                ...
                let var_init_locked_1560908651436;
...
function main(dest , ...sources){
    ...
    return dest ;
        ...
        if(!var_init_locked_1560908651436){

            getKeys = include('object.keys');
set = include('object.value.set');
get = include('object.value.get');

            var_init_locked_1560908651436 = true ;
        }
...
exports['src::array.remove'] = (() =>{
                ...
                let var_init_locked_1560908651437;
 ...
 */
 ...
 for(let item of items){
    ...
    remove(data , data.indexOf(item)) ;
        ...
        if(!var_init_locked_1560908651437){

            remove = include('array.remove.index');

            var_init_locked_1560908651437 = true ;
        }
...
exports['src::is.data.model'] = (() =>{
                ...
                let var_init_locked_1560908651439;
 ...
 */
 ...
 return data instanceof Model ;
        ...
        if(!var_init_locked_1560908651439){

            Model = include('data.model')();

            var_init_locked_1560908651439 = true ;
        }
...
exports['src::data.recordset'] = (() =>{
                ...
                let var_init_locked_1560908651445;

                let var_class_1560908651445;
        ...
        if(!var_init_locked_1560908651445){
...
clone = include('array.clone');
            ...
            var_init_locked_1560908651445 = true ;
        }
        

                    
        if(!var_class_1560908651445){
 ...
 function resetRecordData(recordData){
    ...
    while((index = recordData.indexOf(undefined)) !== -1){
        ...
        removeIndex(recordData , index) ;
            ...
            var_class_1560908651445 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1560908651445 ;
                }
                    ...
                    return new var_class_1560908651445(store);
                } ;
...
exports['src::data.store.base'] = (() =>{
                ...
                let var_init_locked_1560908651446;

                let var_class_1560908651446;
        ...
        if(!var_init_locked_1560908651446){
...
createRecordset = include('data.recordset');
            ...
            var_init_locked_1560908651446 = true ;
        }
        

                    
        if(!var_class_1560908651446){
...
class main{
    ...
    onProxyRead(proxy , records){
        ...
        me.fireEvent('load' , records) ;
            ...
            var_class_1560908651446 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1560908651446 ;
                }
...
exports['src::object.link'] = (() =>{
                ...
                let var_init_locked_1560908651447;
 ...
 */
 ...
 for(let name of names){
    ...
    if(isFunction(value)){
        ...
        if(!var_init_locked_1560908651447){

            isFunction = include('is.function');

            var_init_locked_1560908651447 = true ;
        }
...
exports['src::data.store.constructor'] = (() =>{
                ...
                let var_init_locked_1560908651450;
...
link(me , recordset , [
    ...
    'getById'
        ...
        if(!var_init_locked_1560908651450){
...
link = include('object.link');
            ...
            var_init_locked_1560908651450 = true ;
        }
...
exports['src::data.store.remove'] = (() =>{
                ...
                let var_init_locked_1560908651453;
 ...
 */
 ...
 return records ;
        ...
        if(!var_init_locked_1560908651453){

            remove = include('array.remove');
from = include('array.from');

            var_init_locked_1560908651453 = true ;
        }
...
exports['src::data.store'] = (() =>{
                ...
                let mixin_1560908651136__1,extend,constructor,method_add,method_insert,method_remove,method_load,method_clear;

                let var_init_locked_1560908651455;

                let var_class_1560908651455;
        ...
        if(!var_init_locked_1560908651455){

            mixin_1560908651136__1 = include('mixin.observable');
...
method_clear = include('src::data.store.clear');
            ...
            var_init_locked_1560908651455 = true ;
        }
        

                    
        if(!var_class_1560908651455){
...
clear(...args){
            ...
            var_class_1560908651455 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1560908651455 ;
                }
...
exports['src::data.store.create'] = (() =>{
                ...
                let var_init_locked_1560908651456;
...
return create('data.store' , store) ;
        ...
        if(!var_init_locked_1560908651456){

            create = include('class.create.option');
srcDataStore = include('src::data.store');

            var_init_locked_1560908651456 = true ;
        }
...
exports['src::mixin.region.xy.anchor.set'] = (() =>{
                ...
                let var_init_locked_1560908651462;
...
switch(anchor){
   ...
   case 'b':
       ...
       return assign({
        ...
        if(!var_init_locked_1560908651462){

            isDefined = include('is.defined');

            var_init_locked_1560908651462 = true ;
        }
...
exports['src::data.model.node.tree.base'] = (() =>{
                ...
                let var_init_locked_1560908651468;

                let var_class_1560908651468;
        ...
        if(!var_init_locked_1560908651468){
...
isEmpty = include('is.object.empty');
            ...
            var_init_locked_1560908651468 = true ;
        }
        

                    
        if(!var_class_1560908651468){
 ...
 function getChildNode(property){
    ...
    if(children.length){
        ...
        switch(property){
            ...
            var_class_1560908651468 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1560908651468 ;
                }
...
exports['src::math.region'] = (() =>{
                ...
                let var_init_locked_1560908651470;

                let var_class_1560908651470;
        ...
        if(!var_init_locked_1560908651470){

            region = include('mixin.region');

            var_init_locked_1560908651470 = true ;
        }
        

                    
        if(!var_class_1560908651470){
   ...
   containTo(region){
      ...
      return {
         ...
         y:offsetY
            ...
            var_class_1560908651470 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1560908651470 ;
                }
                    ...
                    return new var_class_1560908651470({x , y , width , height});
                } ;
...
exports['src::data.model.node.tree.region'] = (() =>{
                ...
                let var_init_locked_1560908651471;
 ...
 */
 ...
 return createRegion({
     ...
     height
        ...
        if(!var_init_locked_1560908651471){

            createRegion = include('math.region');

            var_init_locked_1560908651471 = true ;
        }
...
exports['src::data.model.node.tree.nodes.descendant'] = (() =>{
                ...
                let var_init_locked_1560908651476;

                let var_current_scope_1560908651476;
...
return result ;
        ...
        if(!var_current_scope_1560908651476 !== this){

            getChildNodes = include('src::data.model.node.tree.nodes.child').bind(this);

            var_current_scope_1560908651476 = this ;
        }
...
exports['src::data.model.node.tree.select.up'] = (() =>{
                ...
                let var_init_locked_1560908651493;

                let var_current_scope_1560908651493;
...
return select('up') ;
        ...
        if(!var_current_scope_1560908651493 !== this){

            select = include('src::data.model.node.tree.select.vertical').bind(this);

            var_current_scope_1560908651493 = this ;
        }
...
exports['src::data.model.node.tree.select.right'] = (() =>{
                ...
                let var_init_locked_1560908651499;
...
if(firstChildNode){
    ...
    if(nearestNode){
        ...
        if(!var_init_locked_1560908651499){

            getDistance = include('math.point.distance');

            var_init_locked_1560908651499 = true ;
        }
...
exports['src::data.model.node.tree'] = (() =>{
                ...
                let mixin_1560908651197__1,extend,get_region,get_depth,get_childCountScopeHeight,get_scopeHeight,get_descendantNodes,get_children,get_lastLeafNode,get_leafNodes,method_layout,method_expand,method_collapse,method_select,method_deselect,method_selectUp,method_selectDown,method_selectLeft,method_selectRight,method_getDepthNodes,method_appendChild,method_insertAfter,method_removeChild;

                let var_init_locked_1560908651512;

                let var_class_1560908651512;
        ...
        if(!var_init_locked_1560908651512){

            mixin_1560908651197__1 = include('mixin.region');
...
method_removeChild = include('src::data.model.node.tree.remove');
            ...
            var_init_locked_1560908651512 = true ;
        }
        

                    
        if(!var_class_1560908651512){
...
get leafNodes(){
            ...
            var_class_1560908651512 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1560908651512 ;
                }
...
exports['src::data.store.tree.base'] = (() =>{
                ...
                let var_init_locked_1560908651514;

                let var_class_1560908651514;
        ...
        if(!var_init_locked_1560908651514){
...
from = include('array.from');
            ...
            var_init_locked_1560908651514 = true ;
        }
        

                    
        if(!var_class_1560908651514){
 ...
 function initNodeVisible(node){
    ...
    if(node.expanded){
        ...
        for(let childNode of childNodes){
            ...
            var_class_1560908651514 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1560908651514 ;
                }
...
exports['src::data.store.tree.remove'] = (() =>{
                ...
                let var_init_locked_1560908651521;
...
me.fireEvent('remove' , removeNodes) ;
        ...
        if(!var_init_locked_1560908651521){

            from = include('array.from');

            var_init_locked_1560908651521 = true ;
        }
...
exports['src::data.store.tree'] = (() =>{
                ...
                let var_init_locked_1560908651522;

                let var_class_1560908651522;
        ...
        if(!var_init_locked_1560908651522){
...
method_layout = include('src::data.store.tree.layout');
            ...
            var_init_locked_1560908651522 = true ;
        }
        

                    
        if(!var_class_1560908651522){
...
layout(...args){
            ...
            var_class_1560908651522 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1560908651522 ;
                }
                    ...
                    return new var_class_1560908651522(options);
                } ;
...
exports['src::browser.global.listener.map'] = (() =>{
                ...
                let var_once_value_1560908651522;
 ...
 */
 ...
 return map ;
        ...
        if(var_once_value_1560908651522){

            return var_once_value_1560908651522 ;

        }
        return var_once_value_1560908651522 = main.call(this ) ;
...
exports['src::browser.selector.parent'] = (() =>{
                ...
                let var_init_locked_1560908651524;
 ...
 */
 ...
 while(el){
    ...
    el = el.parentElement ;
        ...
        if(!var_init_locked_1560908651524){

            is = include('src::browser.selector.is');

            var_init_locked_1560908651524 = true ;
        }
...
exports['src::browser.global.listener.add'] = (() =>{
                ...
                let var_init_locked_1560908651525;
...
exports['src::browser.global.listener.remove'] = (() =>{
                ...
                let var_init_locked_1560908651527;
...
if(listenerFn){
    ...
    window.removeEventListener(event , listenerFn) ;
        ...
        if(!var_init_locked_1560908651527){

            getMap = include('src::browser.global.listener.map');

            var_init_locked_1560908651527 = true ;
        }
...
exports['src::canvas.draw.line.bezierCurve'] = (() =>{
                ...
                let var_init_locked_1560908651528;
 ...
 */
 ...
 if(points.length === 8){
    ...
    context.stroke();
        ...
        if(!var_init_locked_1560908651528){

            assign = include('object.assign');

            var_init_locked_1560908651528 = true ;
        }
...
exports['src::is.browser.support.pointer'] = (() =>{
                ...
                let var_once_value_1560908651531;
...
return window.hasOwnProperty('onpointerdown');
        ...
        if(var_once_value_1560908651531){

            return var_once_value_1560908651531 ;

        }
        return var_once_value_1560908651531 = main.call(this ) ;
...
exports['src::browser.event.name.single'] = (() =>{
                ...
                let var_init_locked_1560908651534;
...
exports['src::browser.event.gesture.tap.disabled'] = (() =>{
                ...
                let var_init_locked_1560908651537;
...
exports['src::os.name'] = (() =>{
                ...
                let var_once_value_1560908651539;
...
return name ;
        ...
        if(var_once_value_1560908651539){

            return var_once_value_1560908651539 ;

        }
        return var_once_value_1560908651539 = main.call(this ) ;
...
exports['src::browser.scale'] = (() =>{
                ...
                let var_init_locked_1560908651540;
...
return window.devicePixelRatio ;
        ...
        if(!var_init_locked_1560908651540){

            osName = include('os.name');

            var_init_locked_1560908651540 = true ;
        }
...
exports['src::browser.event.gesture.tap.move'] = (() =>{
                ...
                let var_init_locked_1560908651542;

                let var_current_scope_1560908651542;
...
if(round(abs(getDistance({
    ...
    disabled() ;
        ...
        if(!var_init_locked_1560908651542){
...
moveDistance = config('event.tap' , 'moveDistance');
            ...
            var_init_locked_1560908651542 = true ;
        }
        

                    
        if(!var_current_scope_1560908651542 !== this){

            disabled = include('src::browser.event.gesture.tap.disabled').bind(this);

            var_current_scope_1560908651542 = this ;
        }
...
exports['src::browser.event.gesture.tap.start.global'] = (() =>{
                ...
                let var_init_locked_1560908651543;

                let var_current_scope_1560908651543;
 ...
 */
 ...
 if(getTouchEvents(e)){
    ...
    disabled() ;
        ...
        if(!var_init_locked_1560908651543){

            getTouchEvents = include('browser.event.touches');
stop = include('browser.event.stop');

            var_init_locked_1560908651543 = true ;
        }
        

                    
        if(!var_current_scope_1560908651543 !== this){

            disabled = include('src::browser.event.gesture.tap.start.disabled').bind(this);

            var_current_scope_1560908651543 = this ;
        }
...
exports['src::browser.event.gesture.tap.enabled'] = (() =>{
                ...
                let var_init_locked_1560908651544;

                let var_current_scope_1560908651544;
 ...
 */
 ...
 on(getName('end') , me.onEnd = onEnd) ;
        ...
        if(!var_init_locked_1560908651544){

            getName = include('browser.event.name.single');
on = include('browser.global.listener.add');

            var_init_locked_1560908651544 = true ;
        }
        

                    
        if(!var_current_scope_1560908651544 !== this){
...
onStart = include('src::browser.event.gesture.tap.start.global').bind(this);
            ...
            var_current_scope_1560908651544 = this ;
        }
...
exports['src::browser.event.gesture.tap.start'] = (() =>{
                ...
                let var_init_locked_1560908651545;

                let var_current_scope_1560908651545;
 ...
 */
 ...
 if(getTouchEvents(e)){
    ...
    enabled() ;
        ...
        if(!var_init_locked_1560908651545){
...
timeout = config('event.tap' , 'timeout');
            ...
            var_init_locked_1560908651545 = true ;
        }
        

                    
        if(!var_current_scope_1560908651545 !== this){

            enabled = include('src::browser.event.gesture.tap.enabled').bind(this);
disabled = include('src::browser.event.gesture.tap.disabled').bind(this);

            var_current_scope_1560908651545 = this ;
        }
...
exports['src::browser.event.gesture.manager.dom'] = (() =>{
                ...
                let var_init_locked_1560908651546;

                let var_class_1560908651546;

                let var_once_value_1560908651546;

                return function(){

                    
        if(!var_init_locked_1560908651546){

            getName = include('src::browser.event.gesture.name.start');
createMap = include('map');

            var_init_locked_1560908651546 = true ;
        }
        

                    
        if(!var_class_1560908651546){
 ...
 class main {
    ...
    uninstall(el , name){
        ...
        if(listener){
            ...
            var_class_1560908651546 = class extends main{
                ...
                get ZBEE_CURRENT_CLASS(){
                    ...
                    return var_class_1560908651546 ;
                }
        ...
        if(var_once_value_1560908651546){

            return var_once_value_1560908651546 ;

        }

        return var_once_value_1560908651546 = new var_class_1560908651546() ;
