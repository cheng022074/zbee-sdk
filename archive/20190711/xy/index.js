...
exports['src::is.array'] = (() => {
    ...
    let var_init_locked_1562815357080;
    ...
    return function(data) {
        ...
        if (!var_init_locked_1562815357080) {

            isType = include('is.type');

            var_init_locked_1562815357080 = true;
        }
...
exports['src::is.empty'] = (() => {
    ...
    let var_init_locked_1562815357084;
    ...
    return function(data, allowEmptyString = false) {
        ...
        if (!var_init_locked_1562815357084) {

            isArray = include('is.array');

            var_init_locked_1562815357084 = true;
        }
...
exports['src::is.string'] = (() => {
    ...
    let var_init_locked_1562815357086;
    ...
    return function(data) {
        ...
        if (!var_init_locked_1562815357086) {

            isType = include('is.type');

            var_init_locked_1562815357086 = true;
        }
...
exports['src::array.from'] = (() => {
    ...
    let var_init_locked_1562815357089;
    ...
    return function(data) {
        ...
        if (!var_init_locked_1562815357089) {

            isEmpty = include('is.empty');
            isString = include('is.string');

            var_init_locked_1562815357089 = true;
        }
...
exports['src::date.get.properties'] = (() => {
    ...
    let var_init_locked_1562815357096;
    ...
    return function(date, names) {
        ...
        if (!var_init_locked_1562815357096) {

            from = include('array.from');

            var_init_locked_1562815357096 = true;
        }
...
exports['src::array.dates.includes'] = (() => {
    ...
    let var_init_locked_1562815357101;
    ...
    return function(dates, date, fields = ['year', 'month', 'day']) {
        ...
        if (!var_init_locked_1562815357101) {

            get = include('date.get.properties');

            var_init_locked_1562815357101 = true;
        }
...
exports['src::array.remove'] = (() => {
    ...
    let var_init_locked_1562815357114;
    ...
    return function(data, ...items) {
        ...
        if (!var_init_locked_1562815357114) {

            remove = include('array.remove.index');

            var_init_locked_1562815357114 = true;
        }
...
exports['src::array.remove.all'] = (() => {
    ...
    let var_init_locked_1562815357116;
    ...
    return function(data, item) {
        ...
        if (!var_init_locked_1562815357116) {

            remove = include('array.remove');

            var_init_locked_1562815357116 = true;
        }
...
exports['src::url.append'] = (() => {
    ...
    let var_init_locked_1562815357125;
    ...
    return function(url, data) {
        ...
        if (!var_init_locked_1562815357125) {

            isString = include('is.string');

            var_init_locked_1562815357125 = true;
        }
...
exports['src::url.template.apply'] = (() => {
    ...
    let var_init_locked_1562815357130;
    ...
    return function(url, data) {
        ...
        if (!var_init_locked_1562815357130) {

            isInt = include('regexp.int');

            var_init_locked_1562815357130 = true;
        }
...
exports['src::data.connection.ajax.request'] = (() => {
    ...
    let var_init_locked_1562815357136;
    ...
    return function(url, {
        ...
        if (!var_init_locked_1562815357136) {

            append = include('url.append');
            apply = include('url.template.apply');
            isObject = include('is.object.simple');

            var_init_locked_1562815357136 = true;
        }
...
exports['src::data.connection.ajax.request.browser'] = (() => {
    ...
    let var_init_locked_1562815357141;
    ...
    return function(url, config) {
        ...
        if (!var_init_locked_1562815357141) {

            request = include('src::data.connection.ajax.request');

            var_init_locked_1562815357141 = true;
        }
...
exports['src::data.connection.ajax.request.miniprogram'] = (() => {
    ...
    let var_init_locked_1562815357149;
    ...
    return function(url, config) {
        ...
        if (!var_init_locked_1562815357149) {

            request = include('src::data.connection.ajax.request');

            var_init_locked_1562815357149 = true;
        }
...
exports['src::is.function'] = (() => {
    ...
    let var_init_locked_1562815357152;
    ...
    return function(data) {
        ...
        if (!var_init_locked_1562815357152) {

            isType = include('is.type');

            var_init_locked_1562815357152 = true;
        }
...
exports['src::is.boolean'] = (() => {
    ...
    let var_init_locked_1562815357155;
    ...
    return function(data) {
        ...
        if (!var_init_locked_1562815357155) {

            isType = include('is.type');

            var_init_locked_1562815357155 = true;
        }
...
exports['src::class.empty'] = (() => {
    ...
    let var_once_value_1562815357158;
    ...
    return function() {
        ...
        if (var_once_value_1562815357158) {

            return var_once_value_1562815357158;

        }
        return var_once_value_1562815357158 = main.call(this);
...
exports['src::map.set'] = (() => {
    ...
    let var_init_locked_1562815357173;

    let var_current_scope_1562815357173;
    ...
    return function(...values) {
        ...
        if (!var_current_scope_1562815357173 !== this) {

            find = include('src::map.find').bind(this);

            var_current_scope_1562815357173 = this;
        }
...
exports['src::map.get'] = (() => {
    ...
    let var_init_locked_1562815357178;

    let var_current_scope_1562815357178;
    ...
    return function(...keys) {
        ...
        if (!var_current_scope_1562815357178 !== this) {

            find = include('src::map.find').bind(this);

            var_current_scope_1562815357178 = this;
        }
...
exports['src::map.has'] = (() => {
    ...
    let var_init_locked_1562815357180;

    let var_current_scope_1562815357180;
    ...
    return function(...keys) {
        ...
        if (!var_current_scope_1562815357180 !== this) {

            find = include('src::map.find').bind(this);

            var_current_scope_1562815357180 = this;
        }
...
exports['src::map.delete'] = (() => {
    ...
    let var_init_locked_1562815357183;

    let var_current_scope_1562815357183;
    ...
    return function(...keys) {
        ...
        if (!var_current_scope_1562815357183 !== this) {

            find = include('src::map.find').bind(this);

            var_current_scope_1562815357183 = this;
        }
...
exports['src::map'] = (() => {
    ...
    let var_init_locked_1562815357193;

    let var_class_1562815357193;
    ...
    return function() {
        ...
        if (!var_init_locked_1562815357193) {
            ...
            var_init_locked_1562815357193 = true;
        }



        if (!var_class_1562815357193) {
            ...
            var_class_1562815357193 = class extends main {
                ...
                get ZBEE_CURRENT_CLASS() {
                    ...
                    return var_class_1562815357193;
                }
        ...
        return new var_class_1562815357193();
    };
...
exports['src::mixin.observable.constructor'] = (() => {
    ...
    let var_init_locked_1562815357198;
    ...
    return function() {
        ...
        if (!var_init_locked_1562815357198) {

            createMap = include('map');

            var_init_locked_1562815357198 = true;
        }
...
exports['src::mixin.observable.listeners.add'] = (() => {
    ...
    let var_init_locked_1562815357211;
    ...
    return function(listeners) {
        ...
        if (!var_init_locked_1562815357211) {

            isObject = include('is.object.simple');
            isFunction = include('is.function');

            var_init_locked_1562815357211 = true;
        }
...
exports['src::function.get'] = (() => {
    ...
    let var_init_locked_1562815357221;
    ...
    return function(fn, scope) {
        ...
        if (!var_init_locked_1562815357221) {

            isString = include('is.string');
            isFunction = include('is.function');
            empty = include('function.empty');

            var_init_locked_1562815357221 = true;
        }
...
exports['src::mixin.observable.listener.add'] = (() => {
    ...
    let var_init_locked_1562815357227;
    ...
    return function(event, fn, scope, {
        ...
        if (!var_init_locked_1562815357227) {

            get = include('function.get');

            var_init_locked_1562815357227 = true;
        }
...
exports['src::mixin.observable.fire'] = (() => {
    ...
    let var_init_locked_1562815357239;
    ...
    return function(event, ...args) {
        ...
        if (!var_init_locked_1562815357239) {

            isArray = include('is.array');

            var_init_locked_1562815357239 = true;
        }
...
exports['src::mixin.observable'] = (() => {
    ...
    let var_init_locked_1562815357248;
    ...
    return function(extend) {
        ...
        if (!var_init_locked_1562815357248) {
            ...
            var_init_locked_1562815357248 = true;
        }
...
exports['src::data.subscriber.constructor'] = (() => {
    ...
    let var_init_locked_1562815357257;
    ...
    return function(name, {
        ...
        if (!var_init_locked_1562815357257) {

            get = include('function.get');

            var_init_locked_1562815357257 = true;
        }
...
exports['src::data.subscriber.accept'] = (() => {
    ...
    let var_init_locked_1562815357265;
    ...
    return function(data) {
        ...
        if (!var_init_locked_1562815357265) {

            isDefined = include('is.defined');

            var_init_locked_1562815357265 = true;
        }
...
exports['src::object.keys'] = (() => {
    ...
    let var_init_locked_1562815357271;
    ...
    return function(data) {
        ...
        if (!var_init_locked_1562815357271) {

            isObject = include('is.object.simple');

            var_init_locked_1562815357271 = true;
        }
...
exports['src::is.object'] = (() => {
    ...
    let var_init_locked_1562815357274;
    ...
    return function(data) {
        ...
        if (!var_init_locked_1562815357274) {

            isType = include('is.type');

            var_init_locked_1562815357274 = true;
        }
...
exports['src::object.value.get'] = (() => {
    ...
    let var_init_locked_1562815357279;
    ...
    return function(data, key = '.') {
        ...
        if (!var_init_locked_1562815357279) {
            ...
            var_init_locked_1562815357279 = true;
        }
...
exports['src::object.equals'] = (() => {
    ...
    let var_init_locked_1562815357283;
    ...
    return function(value1, value2) {
        ...
        if (!var_init_locked_1562815357283) {

            keys = include('object.keys');
            get = include('object.value.get');

            var_init_locked_1562815357283 = true;
        }
...
exports['src::string.split'] = (() => {
    ...
    let var_init_locked_1562815357286;
    ...
    return function(target, splitRe) {
        ...
        if (!var_init_locked_1562815357286) {

            isEmpty = include('is.empty');

            var_init_locked_1562815357286 = true;
        }
...
exports['src::object.value.set'] = (() => {
    ...
    let var_init_locked_1562815357290;
    ...
    return function(target, key, value) {
        ...
        if (!var_init_locked_1562815357290) {

            isObject = include('is.object');
            split = include('string.split');

            var_init_locked_1562815357290 = true;
        }
...
exports['src::object.assign'] = (() => {
    ...
    let var_init_locked_1562815357295;
    ...
    return function(dest, ...sources) {
        ...
        if (!var_init_locked_1562815357295) {

            getKeys = include('object.keys');
            set = include('object.value.set');
            get = include('object.value.get');

            var_init_locked_1562815357295 = true;
        }
...
exports['src::data.subscriber.open'] = (() => {
    ...
    let var_init_locked_1562815357301;
    ...
    return function(params = {}) {
        ...
        if (!var_init_locked_1562815357301) {

            equals = include('object.equals');
            assign = include('object.assign');

            var_init_locked_1562815357301 = true;
        }
...
exports['src::data.subscriber'] = (() => {
    ...
    let mixin_1562815356693__1, extend, constructor, get_closed, method_accept, method_reopen, method_open, method_close, method_destroy;

    let var_init_locked_1562815357313;

    let var_class_1562815357313;
    ...
    return function() {
        ...
        if (!var_init_locked_1562815357313) {

            mixin_1562815356693__1 = include('mixin.observable');
            extend = include('class.empty')();
            ...
            var_init_locked_1562815357313 = true;
        }



        if (!var_class_1562815357313) {
            ...
            var_class_1562815357313 = class extends main {
                ...
                get ZBEE_CURRENT_CLASS() {
                    ...
                    return var_class_1562815357313;
                }
...
exports['src::is.class'] = (() => {
    ...
    let var_init_locked_1562815357323;
    ...
    return function(data) {
        ...
        if (!var_init_locked_1562815357323) {

            isType = include('is.type');

            var_init_locked_1562815357323 = true;
        }
...
exports['src::class.create'] = (() => {
    ...
    let var_init_locked_1562815357326;
    ...
    return function(baseClass, ...args) {
        ...
        if (!var_init_locked_1562815357326) {

            isString = include('is.string');
            isFunction = include('is.function');
            isClass = include('is.class');

            var_init_locked_1562815357326 = true;
        }
...
exports['src::data.connection.base'] = (() => {
    ...
    let var_init_locked_1562815357330;

    let var_class_1562815357330;
    ...
    return function() {
        ...
        if (!var_init_locked_1562815357330) {
            ...
            var_init_locked_1562815357330 = true;
        }



        if (!var_class_1562815357330) {
            ...
            var_class_1562815357330 = class extends main {
                ...
                get ZBEE_CURRENT_CLASS() {
                    ...
                    return var_class_1562815357330;
                }
...
exports['src::data.connection.subscribe'] = (() => {
    ...
    let var_init_locked_1562815357343;
    ...
    return function(name, options = {}) {
        ...
        if (!var_init_locked_1562815357343) {

            assign = include('object.assign');

            var_init_locked_1562815357343 = true;
        }
...
exports['src::data.connection.subscribes'] = (() => {
    ...
    let var_init_locked_1562815357352;
    ...
    return function(config) {
        ...
        if (!var_init_locked_1562815357352) {
            ...
            var_init_locked_1562815357352 = true;
        }
...
exports['src::data.connection'] = (() => {
    ...
    let var_init_locked_1562815357360;

    let var_class_1562815357360;
    ...
    return function() {
        ...
        if (!var_init_locked_1562815357360) {
            ...
            var_init_locked_1562815357360 = true;
        }



        if (!var_class_1562815357360) {
            ...
            var_class_1562815357360 = class extends main {
                ...
                get ZBEE_CURRENT_CLASS() {
                    ...
                    return var_class_1562815357360;
                }
...
exports['src::data.connection.ajax'] = (() => {
    ...
    let var_init_locked_1562815357372;

    let var_class_1562815357372;
    ...
    return function(options) {
        ...
        if (!var_init_locked_1562815357372) {

            Connection = include('data.connection')();

            var_init_locked_1562815357372 = true;
        }



        if (!var_class_1562815357372) {
            ...
            var_class_1562815357372 = class extends main {
                ...
                get ZBEE_CURRENT_CLASS() {
                    ...
                    return var_class_1562815357372;
                }
        ...
        return new var_class_1562815357372(options);
    };
...
exports['src::data.connection.deploy'] = (() => {
    ...
    let var_init_locked_1562815357388;





    function main(subscriberMap) {
    ...
    return function(subscriberMap) {


        if (!var_init_locked_1562815357388) {

            generate = include('id.generate');

            var_init_locked_1562815357388 = true;
        }




        return main.call(this, subscriberMap);
    };
...
exports['src::data.connection.deploy.lifecycle'] = (() => {
    ...
    let var_init_locked_1562815357392;
    ...
    return function(connections, component, prefix = '$') {
        ...
        if (!var_init_locked_1562815357392) {

            deploy = include('src::data.connection.deploy');

            var_init_locked_1562815357392 = true;
        }
...
exports['src::data.connection.deploy.miniprogram'] = (() => {
    ...
    let var_init_locked_1562815357395;
    ...
    return function(connections, component) {
        ...
        if (!var_init_locked_1562815357395) {

            empty = include('function.empty')();
            deploy = include('src::data.connection.deploy.lifecycle');

            var_init_locked_1562815357395 = true;
        }
...
exports['src::data.connection.deploy.module'] = (() => {
    ...
    let var_init_locked_1562815357397;
    ...
    return function(connections, module) {
        ...
        if (!var_init_locked_1562815357397) {

            empty = include('function.empty')();
            deploy = include('src::data.connection.deploy.lifecycle');

            var_init_locked_1562815357397 = true;
        }
...
exports['src::data.connection.deploy.vue'] = (() => {
    ...
    let var_init_locked_1562815357408;
    ...
    return function(connections, component) {
        ...
        if (!var_init_locked_1562815357408) {

            empty = include('function.empty')();
            deploy = include('src::data.connection.deploy.lifecycle');

            var_init_locked_1562815357408 = true;
        }
...
exports['src::data.connection.flow'] = (() => {
    ...
    let var_init_locked_1562815357415;

    let var_class_1562815357415;
    ...
    return function(message, flows, methods, callback, scoped) {
        ...
        if (!var_init_locked_1562815357415) {
            ...
            var_init_locked_1562815357415 = true;
        }



        if (!var_class_1562815357415) {
            ...
            var_class_1562815357415 = class extends main {
                ...
                get ZBEE_CURRENT_CLASS() {
                    ...
                    return var_class_1562815357415;
                }
        ...
        return new var_class_1562815357415(message, flows, methods, callback, scoped);
    };
...
exports['src::data.Subscriber.constructor'] = (() => {
    ...
    let var_init_locked_1562815357420;
    ...
    return function(name, {
        ...
        if (!var_init_locked_1562815357420) {

            get = include('function.get');

            var_init_locked_1562815357420 = true;
        }
...
exports['src::data.Subscriber.accept'] = (() => {
    ...
    let var_init_locked_1562815357423;
    ...
    return function(data) {
        ...
        if (!var_init_locked_1562815357423) {

            isDefined = include('is.defined');

            var_init_locked_1562815357423 = true;
        }
...
exports['src::data.Subscriber.open'] = (() => {
    ...
    let var_init_locked_1562815357429;
    ...
    return function(params = {}) {
        ...
        if (!var_init_locked_1562815357429) {

            equals = include('object.equals');
            assign = include('object.assign');

            var_init_locked_1562815357429 = true;
        }
...
exports['src::data.Subscriber'] = (() => {
    ...
    let mixin_1562815356754__1, extend, constructor, get_closed, method_accept, method_reopen, method_open, method_close, method_destroy;

    let var_init_locked_1562815357439;

    let var_class_1562815357439;
    ...
    return function() {
        ...
        if (!var_init_locked_1562815357439) {

            mixin_1562815356754__1 = include('mixin.observable');
            extend = include('class.empty')();
            constructor = include('src::data.Subscriber.constructor');
            get_closed = include('src::data.subscriber.closed');
            method_accept = include('src::data.Subscriber.accept');
            ...
            var_init_locked_1562815357439 = true;
        }



        if (!var_class_1562815357439) {
            ...
            var_class_1562815357439 = class extends main {
                ...
                get ZBEE_CURRENT_CLASS() {
                    ...
                    return var_class_1562815357439;
                }
...
exports['src::data.connection.message.address'] = (() => {
    ...
    let var_init_locked_1562815357449;

    let var_class_1562815357449;
    ...
    return function(name, options) {
        ...
        if (!var_init_locked_1562815357449) {

            Subscriber = include('data.Subscriber')();
            isDefined = include('is.defined');

            var_init_locked_1562815357449 = true;
        }



        if (!var_class_1562815357449) {
            ...
            var_class_1562815357449 = class extends main {
                ...
                get ZBEE_CURRENT_CLASS() {
                    ...
                    return var_class_1562815357449;
                }
        ...
        return new var_class_1562815357449(name, options);
    };
...
exports['src::data.connection.message'] = (() => {
    ...
    let var_init_locked_1562815357460;

    let var_class_1562815357460;
    ...
    return function() {
        ...
        if (!var_init_locked_1562815357460) {
            ...
            var_init_locked_1562815357460 = true;
        }



        if (!var_class_1562815357460) {
            ...
            var_class_1562815357460 = class extends main {
                ...
                get ZBEE_CURRENT_CLASS() {
                    ...
                    return var_class_1562815357460;
                }
        ...
        return new var_class_1562815357460();
    };
...
exports['src::data.connection.socket'] = (() => {
    ...
    let var_init_locked_1562815357475;

    let var_class_1562815357475;
    ...
    return function() {
        ...
        if (!var_init_locked_1562815357475) {
            ...
            var_init_locked_1562815357475 = true;
        }



        if (!var_class_1562815357475) {
            ...
            var_class_1562815357475 = class extends main {
                ...
                get ZBEE_CURRENT_CLASS() {
                    ...
                    return var_class_1562815357475;
                }
...
exports['src::data.connection.socket.io'] = (() => {
    ...
    let var_init_locked_1562815357488;

    let var_class_1562815357488;
    ...
    return function() {
        ...
        if (!var_init_locked_1562815357488) {

            Connection = include('data.connection.socket')();

            var_init_locked_1562815357488 = true;
        }



        if (!var_class_1562815357488) {
            ...
            var_class_1562815357488 = class extends main {
                ...
                get ZBEE_CURRENT_CLASS() {
                    ...
                    return var_class_1562815357488;
                }
...
exports['src::data.connection.socket.standard'] = (() => {
    ...
    let var_init_locked_1562815357502;
    ...
    return function(url, config) {
        ...
        if (!var_init_locked_1562815357502) {

            createTimer = include('timer');

            var_init_locked_1562815357502 = true;
        }
...
exports['src::class.create.option'] = (() => {
    ...
    let var_init_locked_1562815357505;
    ...
    return function(namespace, option) {
        ...
        if (!var_init_locked_1562815357505) {
            ...
            var_init_locked_1562815357505 = true;
        }
...
exports['src::data.reader.json'] = (() => {
    ...
    let var_init_locked_1562815357514;
    ...
    return function({
        ...
        if (!var_init_locked_1562815357514) {
            ...
            var_init_locked_1562815357514 = true;
        }
...
exports['src::data.proxy.constructor'] = (() => {
    ...
    let var_init_locked_1562815357531;
...
exports['src::data.proxy.read'] = (() => {
    ...
    let var_init_locked_1562815357549;
    ...
    return function(options) {
        ...
        if (!var_init_locked_1562815357549) {

            isPromise = include('is.promise');

            var_init_locked_1562815357549 = true;
        }
...
exports['src::data.proxy'] = (() => {
    ...
    let mixin_1562815356828__1, extend, constructor, method_read;

    let var_init_locked_1562815357552;

    let var_class_1562815357552;
    ...
    return function() {
        ...
        if (!var_init_locked_1562815357552) {

            mixin_1562815356828__1 = include('mixin.observable');
            extend = include('class.empty')();
            constructor = include('src::data.proxy.constructor');
            method_read = include('src::data.proxy.read');

            var_init_locked_1562815357552 = true;
        }



        if (!var_class_1562815357552) {
            ...
            var_class_1562815357552 = class extends main {
                ...
                get ZBEE_CURRENT_CLASS() {
                    ...
                    return var_class_1562815357552;
                }
...
exports['src::data.proxy.memory'] = (() => {
    ...
    let var_init_locked_1562815357572;

    let var_class_1562815357572;
    ...
    return function(options) {
        ...
        if (!var_init_locked_1562815357572) {

            Proxy = include('data.proxy')();

            var_init_locked_1562815357572 = true;
        }



        if (!var_class_1562815357572) {
            ...
            var_class_1562815357572 = class extends main {
                ...
                get ZBEE_CURRENT_CLASS() {
                    ...
                    return var_class_1562815357572;
                }
        ...
        return new var_class_1562815357572(options);
    };
...
exports['src::data.proxy.create'] = (() => {
    ...
    let var_init_locked_1562815357589;
...
exports['src::is.proxy.memory'] = (() => {
    ...
    let var_init_locked_1562815357607;
    ...
    return function(data) {
        ...
        if (!var_init_locked_1562815357607) {

            Proxy = include('data.proxy')();

            var_init_locked_1562815357607 = true;
        }
...
exports['src::object.assign.if'] = (() => {
    ...
    let var_init_locked_1562815357624;
    ...
    return function(dest, ...sources) {
        ...
        if (!var_init_locked_1562815357624) {

            getKeys = include('object.keys');
            set = include('object.value.set');
            get = include('object.value.get');

            var_init_locked_1562815357624 = true;
        }
...
exports['src::data.model.base'] = (() => {
    ...
    let var_init_locked_1562815357628;

    let var_class_1562815357628;
    ...
    return function() {
        ...
        if (!var_init_locked_1562815357628) {
            ...
            var_init_locked_1562815357628 = true;
        }



        if (!var_class_1562815357628) {
            ...
            var_class_1562815357628 = class extends main {
                ...
                get ZBEE_CURRENT_CLASS() {
                    ...
                    return var_class_1562815357628;
                }
...
exports['src::data.model.fields'] = (() => {
    ...
    let var_init_locked_1562815357649;
    ...
    return function() {
        ...
        if (!var_init_locked_1562815357649) {
            ...
            var_init_locked_1562815357649 = true;
        }
...
exports['src::data.model.id'] = (() => {
    ...
    let var_init_locked_1562815357669;
    ...
    return function() {
        ...
        if (!var_init_locked_1562815357669) {

            getId = include('id.generate');

            var_init_locked_1562815357669 = true;
        }
...
exports['src::data.model.value.set'] = (() => {
    ...
    let var_init_locked_1562815357679;
    ...
    return function(name, value) {
        ...
        if (!var_init_locked_1562815357679) {

            isString = include('is.string');
            isObject = include('is.object.simple');

            var_init_locked_1562815357679 = true;
        }
...
exports['src::data.model'] = (() => {
    ...
    let mixin_1562815356825__1, extend, static_get_fields, get_isBindStore, get_id, method_bindStore, method_unbindStore, method_has, method_set, method_get, method_load, method_destroy;

    let var_init_locked_1562815357689;

    let var_class_1562815357689;
    ...
    return function() {
        ...
        if (!var_init_locked_1562815357689) {

            mixin_1562815356825__1 = include('mixin.observable');
            ...
            var_init_locked_1562815357689 = true;
        }



        if (!var_class_1562815357689) {
            ...
            var_class_1562815357689 = class extends main {
                ...
                get ZBEE_CURRENT_CLASS() {
                    ...
                    return var_class_1562815357689;
                }
...
exports['src::is.class.from'] = (() => {
    ...
    let var_init_locked_1562815357705;
    ...
    return function(data, baseClass) {
        ...
        if (!var_init_locked_1562815357705) {

            isClass = include('is.class');
            isString = include('is.string');

            var_init_locked_1562815357705 = true;
        }
...
exports['src::is.data.model.class'] = (() => {
    ...
    let var_init_locked_1562815357708;
    ...
    return function(data) {
        ...
        if (!var_init_locked_1562815357708) {

            dataModel = include('data.model');
            isClass = include('is.class.from');

            var_init_locked_1562815357708 = true;
        }
...
exports['src::data.model.get'] = (() => {
    ...
    let var_init_locked_1562815357724;
    ...
    return function(model) {
        ...
        if (!var_init_locked_1562815357724) {
            ...
            var_init_locked_1562815357724 = true;
        }
...
exports['src::data.model.create'] = (() => {
    ...
    let var_init_locked_1562815357745;
    ...
    return function({
        ...
        if (!var_init_locked_1562815357745) {

            Model = include('data.model')();
            get = include('data.model.get');
            define = include('class.define');

            var_init_locked_1562815357745 = true;
        }
...
exports['src::is.data.model'] = (() => {
    ...
    let var_init_locked_1562815357761;
    ...
    return function(data) {
        ...
        if (!var_init_locked_1562815357761) {

            Model = include('data.model')();

            var_init_locked_1562815357761 = true;
        }
...
exports['src::data.recordset'] = (() => {
    ...
    let var_init_locked_1562815357781;

    let var_class_1562815357781;
    ...
    return function(store) {
        ...
        if (!var_init_locked_1562815357781) {
            ...
            var_init_locked_1562815357781 = true;
        }



        if (!var_class_1562815357781) {
            ...
            var_class_1562815357781 = class extends main {
                ...
                get ZBEE_CURRENT_CLASS() {
                    ...
                    return var_class_1562815357781;
                }
        ...
        return new var_class_1562815357781(store);
    };
...
exports['src::data.store.base'] = (() => {
    ...
    let var_init_locked_1562815357798;

    let var_class_1562815357798;
    ...
    return function() {
        ...
        if (!var_init_locked_1562815357798) {
            ...
            var_init_locked_1562815357798 = true;
        }



        if (!var_class_1562815357798) {
            ...
            var_class_1562815357798 = class extends main {
                ...
                get ZBEE_CURRENT_CLASS() {
                    ...
                    return var_class_1562815357798;
                }
...
exports['src::object.link'] = (() => {
    ...
    let var_init_locked_1562815357815;
    ...
    return function(dest, source, names) {
        ...
        if (!var_init_locked_1562815357815) {

            isFunction = include('is.function');

            var_init_locked_1562815357815 = true;
        }
...
exports['src::data.store.constructor'] = (() => {
    ...
    let var_init_locked_1562815357819;
    ...
    return function({
        ...
        if (!var_init_locked_1562815357819) {
            ...
            var_init_locked_1562815357819 = true;
        }
...
exports['src::data.store.remove'] = (() => {
    ...
    let var_init_locked_1562815357839;
    ...
    return function(records, isFireEvent = true) {
        ...
        if (!var_init_locked_1562815357839) {

            remove = include('array.remove');
            from = include('array.from');

            var_init_locked_1562815357839 = true;
        }
...
exports['src::data.store'] = (() => {
    ...
    let mixin_1562815356817__1, extend, constructor, method_add, method_insert, method_remove, method_load, method_clear, method_getById;

    let var_init_locked_1562815357849;

    let var_class_1562815357849;
    ...
    return function() {
        ...
        if (!var_init_locked_1562815357849) {

            mixin_1562815356817__1 = include('mixin.observable');
            ...
            var_init_locked_1562815357849 = true;
        }



        if (!var_class_1562815357849) {
            ...
            var_class_1562815357849 = class extends main {
                ...
                get ZBEE_CURRENT_CLASS() {
                    ...
                    return var_class_1562815357849;
                }
...
exports['src::data.store.create'] = (() => {
    ...
    let var_init_locked_1562815357865;
    ...
    return function(store) {
        ...
        if (!var_init_locked_1562815357865) {

            create = include('class.create.option');
            srcDataStore = include('src::data.store');

            var_init_locked_1562815357865 = true;
        }
...
exports['src::mixin.region.xy.anchor.set'] = (() => {
    ...
    let var_init_locked_1562815357890;
    ...
    return function(xy, anchor = 'tl') {
        ...
        if (!var_init_locked_1562815357890) {

            isDefined = include('is.defined');

            var_init_locked_1562815357890 = true;
        }
...
exports['src::mixin.region'] = (() => {
    ...
    let var_init_locked_1562815357893;
...
exports['src::data.model.node.tree.base'] = (() => {
    ...
    let var_init_locked_1562815357906;

    let var_class_1562815357906;
    ...
    return function() {
        ...
        if (!var_init_locked_1562815357906) {
            ...
            var_init_locked_1562815357906 = true;
        }



        if (!var_class_1562815357906) {
            ...
            var_class_1562815357906 = class extends main {
                ...
                get ZBEE_CURRENT_CLASS() {
                    ...
                    return var_class_1562815357906;
                }
...
exports['src::math.region'] = (() => {
    ...
    let var_init_locked_1562815357927;

    let var_class_1562815357927;
    ...
    return function({
        ...
        if (!var_init_locked_1562815357927) {

            region = include('mixin.region');

            var_init_locked_1562815357927 = true;
        }



        if (!var_class_1562815357927) {
            ...
            var_class_1562815357927 = class extends main {
                ...
                get ZBEE_CURRENT_CLASS() {
                    ...
                    return var_class_1562815357927;
                }
        ...
        return new var_class_1562815357927({
            x,
            y,
            width,
            height
...
exports['src::data.model.node.tree.region'] = (() => {
    ...
    let var_init_locked_1562815357931;
    ...
    return function() {
        ...
        if (!var_init_locked_1562815357931) {

            createRegion = include('math.region');

            var_init_locked_1562815357931 = true;
        }
...
exports['src::data.model.node.tree.nodes.descendant'] = (() => {
    ...
    let var_init_locked_1562815357943;

    let var_current_scope_1562815357943;
    ...
    return function() {
        ...
        if (!var_current_scope_1562815357943 !== this) {

            getChildNodes = include('src::data.model.node.tree.nodes.child').bind(this);

            var_current_scope_1562815357943 = this;
        }
...
exports['src::data.model.node.tree.select.up'] = (() => {
    ...
    let var_init_locked_1562815357969;

    let var_current_scope_1562815357969;
    ...
    return function() {
        ...
        if (!var_current_scope_1562815357969 !== this) {

            select = include('src::data.model.node.tree.select.vertical').bind(this);

            var_current_scope_1562815357969 = this;
        }
...
exports['src::data.model.node.tree.select.down'] = (() => {
    ...
    let var_init_locked_1562815357971;

    let var_current_scope_1562815357971;
    ...
    return function() {
        ...
        if (!var_current_scope_1562815357971 !== this) {

            select = include('src::data.model.node.tree.select.vertical').bind(this);

            var_current_scope_1562815357971 = this;
        }
...
exports['src::data.model.node.tree.select.right'] = (() => {
    ...
    let var_init_locked_1562815357981;
    ...
    return function() {
        ...
        if (!var_init_locked_1562815357981) {

            getDistance = include('math.point.distance');

            var_init_locked_1562815357981 = true;
        }
...
exports['src::data.model.node.tree.remove'] = (() => {
    ...
    let var_init_locked_1562815357996;
    ...
    return function(node) {
        ...
        if (!var_init_locked_1562815357996) {

            remove = include('array.remove');

            var_init_locked_1562815357996 = true;
        }
...
exports['src::data.model.node.tree'] = (() => {
    ...
    let mixin_1562815356875__1, extend, get_region, get_depth, get_childCountScopeHeight, get_scopeHeight, get_descendantNodes, get_children, get_lastLeafNode, get_leafNodes, method_layout, method_expand, method_collapse, method_select, method_deselect, method_selectUp, method_selectDown, method_selectLeft, method_selectRight, method_getDepthNodes, method_appendChild, method_insertAfter, method_removeChild, method_contains;

    let var_init_locked_1562815358002;

    let var_class_1562815358002;
    ...
    return function() {
        ...
        if (!var_init_locked_1562815358002) {

            mixin_1562815356875__1 = include('mixin.region');
            ...
            var_init_locked_1562815358002 = true;
        }



        if (!var_class_1562815358002) {
            ...
            var_class_1562815358002 = class extends main {
                ...
                get ZBEE_CURRENT_CLASS() {
                    ...
                    return var_class_1562815358002;
                }
...
exports['src::data.store.tree.base'] = (() => {
    ...
    let var_init_locked_1562815358024;

    let var_class_1562815358024;
    ...
    return function() {
        ...
        if (!var_init_locked_1562815358024) {
            ...
            var_init_locked_1562815358024 = true;
        }



        if (!var_class_1562815358024) {
            ...
            var_class_1562815358024 = class extends main {
                ...
                get ZBEE_CURRENT_CLASS() {
                    ...
                    return var_class_1562815358024;
                }
...
exports['src::data.store.tree.remove'] = (() => {
    ...
    let var_init_locked_1562815358053;
    ...
    return function(nodes) {
        ...
        if (!var_init_locked_1562815358053) {

            from = include('array.from');

            var_init_locked_1562815358053 = true;
        }
...
exports['src::data.store.tree'] = (() => {
    ...
    let var_init_locked_1562815358061;

    let var_class_1562815358061;
    ...
    return function(options) {
        ...
        if (!var_init_locked_1562815358061) {
            ...
            var_init_locked_1562815358061 = true;
        }



        if (!var_class_1562815358061) {
            ...
            var_class_1562815358061 = class extends main {
                ...
                get ZBEE_CURRENT_CLASS() {
                    ...
                    return var_class_1562815358061;
                }
        ...
        return new var_class_1562815358061(options);
    };
...
exports['src::canvas.draw.line.bezierCurve'] = (() => {
    ...
    let var_init_locked_1562815358086;
    ...
    return function(context, {
        ...
        if (!var_init_locked_1562815358086) {

            assign = include('object.assign');

            var_init_locked_1562815358086 = true;
        }
...
exports['src::canvas.draw.line.arc'] = (() => {
    ...
    let var_init_locked_1562815358092;
    ...
    return function(context, {
        ...
        if (!var_init_locked_1562815358092) {

            assign = include('object.assign');
            degree2radian = include('math.degree2radian');

            var_init_locked_1562815358092 = true;
        }
...
exports['src::is.number'] = (() => {
    ...
    let var_init_locked_1562815358095;
    ...
    return function(data) {
        ...
        if (!var_init_locked_1562815358095) {

            isType = include('is.type');

            var_init_locked_1562815358095 = true;
        }
...
exports['src::date.get'] = (() => {
    ...
    let var_init_locked_1562815358098;
    ...
    return function({
        ...
        if (!var_init_locked_1562815358098) {

            isDefined = include('is.defined');

            var_init_locked_1562815358098 = true;
        }
...
exports['src::date.parse'] = (() => {
    ...
    let var_init_locked_1562815358106;
    ...
    return function(data, regex, format) {
        ...
        if (!var_init_locked_1562815358106) {

            doFormat = include('string.format');

            var_init_locked_1562815358106 = true;
        }
...
exports['src::map.set.multi'] = (() => {
    ...
    let var_init_locked_1562815358109;
    ...
    return function(map, ...values) {
        ...
        if (!var_init_locked_1562815358109) {

            isArray = include('is.array');

            var_init_locked_1562815358109 = true;
        }
...
exports['src::date.prev'] = (() => {
    ...
    let var_init_locked_1562815358115;
...
exports['src::date.next'] = (() => {
    ...
    let var_init_locked_1562815358119;
    ...
    return function(date, step = 1) {
        ...
        if (!var_init_locked_1562815358119) {

            get = include('date.get');
            getProperty = include('date.get.properties');
            isDate = include('is.date');

            var_init_locked_1562815358119 = true;
        }
...
exports['src::month.date.last'] = (() => {
    ...
    let var_init_locked_1562815358122;
    ...
    return function(year, month) {
        ...
        if (!var_init_locked_1562815358122) {

            get = include('date.get');
            prev = include('date.prev');
            getLastDate = include('src::month.date.last');

            var_init_locked_1562815358122 = true;
        }
...
exports['src::calendar.month'] = (() => {
    ...
    let var_init_locked_1562815358128;
    ...
    return function(year, month, {
        ...
        if (!var_init_locked_1562815358128) {
            ...
            var_init_locked_1562815358128 = true;
        }
...
exports['src::calendar.month.view.select'] = (() => {
    ...
    let var_init_locked_1562815358136;

    let var_current_scope_1562815358136;
    ...
    return function(year, month, day) {
        ...
        if (!var_init_locked_1562815358136) {

            getLastDate = include('month.date.last');
            get = include('date.get.properties');

            var_init_locked_1562815358136 = true;
        }



        if (!var_current_scope_1562815358136 !== this) {

            deselect = include('src::calendar.month.view.deselect').bind(this);

            var_current_scope_1562815358136 = this;
        }
...
exports['src::calendar.month.view.selectMonth'] = (() => {
    ...
    let var_init_locked_1562815358141;

    let var_current_scope_1562815358141;
    ...
    return function(year, month) {
        ...
        if (!var_init_locked_1562815358141) {

            getDates = include('src::calendar.month');
            getProperty = include('date.get.properties');

            var_init_locked_1562815358141 = true;
        }



        if (!var_current_scope_1562815358141 !== this) {

            deselect = include('src::calendar.month.view.deselect').bind(this);
            select = include('src::calendar.month.view.select').bind(this);

            var_current_scope_1562815358141 = this;
        }
...
exports['src::calendar.month.view.constructor'] = (() => {
    ...
    let var_init_locked_1562815358145;

    let var_current_scope_1562815358145;
    ...
    return function(target, {
        ...
        if (!var_init_locked_1562815358145) {

            getProxy = include('object.proxy');
            getProperty = include('date.get.properties');

            var_init_locked_1562815358145 = true;
        }



        if (!var_current_scope_1562815358145 !== this) {

            selectMonth = include('src::calendar.month.view.selectMonth').bind(this);
            select = include('src::calendar.month.view.select').bind(this);

            var_current_scope_1562815358145 = this;
        }
...
exports['src::month.prev'] = (() => {
    ...
    let var_init_locked_1562815358152;
    ...
    return function(date) {
        ...
        if (!var_init_locked_1562815358152) {

            get = include('date.get');
            getProperty = include('date.get.properties');
            isDate = include('is.date');

            var_init_locked_1562815358152 = true;
        }
...
exports['src::calendar.month.view.selectPrevMonth'] = (() => {
    ...
    let var_init_locked_1562815358156;

    let var_current_scope_1562815358156;
    ...
    return function() {
        ...
        if (!var_init_locked_1562815358156) {

            prev = include('month.prev');
            getProperty = include('date.get.properties');

            var_init_locked_1562815358156 = true;
        }



        if (!var_current_scope_1562815358156 !== this) {

            selectMonth = include('src::calendar.month.view.selectMonth').bind(this);

            var_current_scope_1562815358156 = this;
        }
...
exports['src::calendar.month.view.selectLeft'] = (() => {
    ...
    let var_init_locked_1562815358161;

    let var_current_scope_1562815358161;
    ...
    return function() {
        ...
        if (!var_init_locked_1562815358161) {
            ...
            var_init_locked_1562815358161 = true;
        }



        if (!var_current_scope_1562815358161 !== this) {

            prevMonth = include('src::calendar.month.view.selectPrevMonth').bind(this);
            select = include('src::calendar.month.view.select').bind(this);

            var_current_scope_1562815358161 = this;
        }
...
exports['src::is.week.day.last'] = (() => {
    ...
    let var_init_locked_1562815358166;
    ...
    return function(date, weekStartDay = 1) {
        ...
        if (!var_init_locked_1562815358166) {

            getDays = include('week.days');

            var_init_locked_1562815358166 = true;
        }
...
exports['src::month.next'] = (() => {
    ...
    let var_init_locked_1562815358168;
    ...
    return function(date) {
        ...
        if (!var_init_locked_1562815358168) {

            get = include('date.get');
            getProperty = include('date.get.properties');
            isDate = include('is.date');

            var_init_locked_1562815358168 = true;
        }
...
exports['src::calendar.month.view.selectNextMonth'] = (() => {
    ...
    let var_init_locked_1562815358171;

    let var_current_scope_1562815358171;
    ...
    return function() {
        ...
        if (!var_init_locked_1562815358171) {

            next = include('month.next');
            getProperty = include('date.get.properties');

            var_init_locked_1562815358171 = true;
        }



        if (!var_current_scope_1562815358171 !== this) {

            selectMonth = include('src::calendar.month.view.selectMonth').bind(this);

            var_current_scope_1562815358171 = this;
        }
...
exports['src::calendar.month.view.selectRight'] = (() => {
    ...
    let var_init_locked_1562815358177;

    let var_current_scope_1562815358177;
    ...
    return function() {
        ...
        if (!var_init_locked_1562815358177) {
            ...
            var_init_locked_1562815358177 = true;
        }



        if (!var_current_scope_1562815358177 !== this) {

            nextMonth = include('src::calendar.month.view.selectNextMonth').bind(this);
            select = include('src::calendar.month.view.select').bind(this);

            var_current_scope_1562815358177 = this;
        }
...
exports['src::month.date.first'] = (() => {
    ...
    let var_init_locked_1562815358182;
    ...
    return function(year, month) {
        ...
        if (!var_init_locked_1562815358182) {

            get = include('date.get');

            var_init_locked_1562815358182 = true;
        }
...
exports['src::month.dates.week.first'] = (() => {
    ...
    let var_init_locked_1562815358184;
    ...
    return function(year, month, weekStartDay = 1) {
        ...
        if (!var_init_locked_1562815358184) {

            getDays = include('week.days');
            getFirstDate = include('month.date.first');
            next = include('date.next');

            var_init_locked_1562815358184 = true;
        }
...
exports['src::date.prev.week'] = (() => {
    ...
    let var_init_locked_1562815358188;
    ...
    return function(date) {
        ...
        if (!var_init_locked_1562815358188) {

            prev = include('date.prev');

            var_init_locked_1562815358188 = true;
        }
...
exports['src::calendar.month.view.selectUp'] = (() => {
    ...
    let var_init_locked_1562815358192;

    let var_current_scope_1562815358192;
    ...
    return function() {
        ...
        if (!var_init_locked_1562815358192) {
            ...
            var_init_locked_1562815358192 = true;
        }



        if (!var_current_scope_1562815358192 !== this) {

            prevMonth = include('src::calendar.month.view.selectPrevMonth').bind(this);
            select = include('src::calendar.month.view.select').bind(this);

            var_current_scope_1562815358192 = this;
        }
...
exports['src::month.dates.week.last'] = (() => {
    ...
    let var_init_locked_1562815358200;
    ...
    return function(year, month, weekStartDay = 1) {
        ...
        if (!var_init_locked_1562815358200) {

            getDays = include('week.days');
            getLastDate = include('month.date.last');
            prev = include('date.prev');

            var_init_locked_1562815358200 = true;
        }
...
exports['src::date.next.week'] = (() => {
    ...
    let var_init_locked_1562815358203;
    ...
    return function(date) {
        ...
        if (!var_init_locked_1562815358203) {

            next = include('date.next');

            var_init_locked_1562815358203 = true;
        }
...
exports['src::calendar.month.view.selectDown'] = (() => {
    ...
    let var_init_locked_1562815358207;

    let var_current_scope_1562815358207;
    ...
    return function() {
        ...
        if (!var_init_locked_1562815358207) {
            ...
            var_init_locked_1562815358207 = true;
        }



        if (!var_current_scope_1562815358207 !== this) {

            nextMonth = include('src::calendar.month.view.selectNextMonth').bind(this);
            select = include('src::calendar.month.view.select').bind(this);

            var_current_scope_1562815358207 = this;
        }
...
exports['src::calendar.month.view'] = (() => {
    ...
    let var_init_locked_1562815358213;

    let var_class_1562815358213;
    ...
    return function(target, config) {
        ...
        if (!var_init_locked_1562815358213) {
            ...
            var_init_locked_1562815358213 = true;
        }



        if (!var_class_1562815358213) {
            ...
            var_class_1562815358213 = class extends main {
                ...
                get ZBEE_CURRENT_CLASS() {
                    ...
                    return var_class_1562815358213;
                }
        ...
        return new var_class_1562815358213(target, config);
    };
...
exports['src::browser.global.listener.map'] = (() => {
    ...
    let var_init_locked_1562815358220;



    let var_once_value_1562815358220;
    ...
    return function() {
        ...
        if (!var_init_locked_1562815358220) {

            map = include('map')();

            var_init_locked_1562815358220 = true;
        }
        ...
        if (var_once_value_1562815358220) {

            return var_once_value_1562815358220;

        }
        return var_once_value_1562815358220 = main.call(this);
...
exports['src::browser.selector.parent'] = (() => {
    ...
    let var_init_locked_1562815358226;
    ...
    return function(el, selector) {
        ...
        if (!var_init_locked_1562815358226) {

            is = include('src::browser.selector.is');

            var_init_locked_1562815358226 = true;
        }
...
exports['src::browser.global.listener.add'] = (() => {
    ...
    let var_init_locked_1562815358228;
...
exports['src::browser.global.listener.remove'] = (() => {
    ...
    let var_init_locked_1562815358232;
    ...
    return function(event, fn, selector) {
        ...
        if (!var_init_locked_1562815358232) {

            getMap = include('src::browser.global.listener.map');

            var_init_locked_1562815358232 = true;
        }
...
exports['src::is.browser.support.pointer'] = (() => {
    ...
    let var_once_value_1562815358242;
    ...
    return function() {
        ...
        if (var_once_value_1562815358242) {

            return var_once_value_1562815358242;

        }
        return var_once_value_1562815358242 = main.call(this);
...
exports['src::is.browser.support.touch'] = (() => {
    ...
    let var_once_value_1562815358244;
    ...
    return function() {
        ...
        if (var_once_value_1562815358244) {

            return var_once_value_1562815358244;

        }
        return var_once_value_1562815358244 = main.call(this);
...
exports['src::browser.event.name.single'] = (() => {
    ...
    let var_init_locked_1562815358246;
...
exports['src::os.name'] = (() => {
    ...
    let var_once_value_1562815358250;
    ...
    return function() {
        ...
        if (var_once_value_1562815358250) {

            return var_once_value_1562815358250;

        }
        return var_once_value_1562815358250 = main.call(this);
...
exports['src::browser.scale'] = (() => {
    ...
    let var_init_locked_1562815358252;
    ...
    return function() {
        ...
        if (!var_init_locked_1562815358252) {

            osName = include('os.name');

            var_init_locked_1562815358252 = true;
        }
...
exports['config::event.tap'] = (() => {
    ...
    let var_init_locked_1562815358254;
    ...
    return function(key) {
        ...
        if (!var_init_locked_1562815358254) {

            get = include('object.value.get');

            var_init_locked_1562815358254 = true;
        }
...
exports['src::browser.event.gesture.tap.move'] = (() => {
    ...
    let var_init_locked_1562815358258;
    ...
    return function(e) {
        ...
        if (!var_init_locked_1562815358258) {
            ...
            var_init_locked_1562815358258 = true;
        }
...
exports['src::browser.event.gesture.tap.disabled'] = (() => {
    ...
    let var_init_locked_1562815358262;
...
exports['src::browser.event.gesture.tap.end'] = (() => {
    ...
    let var_init_locked_1562815358268;

    let var_current_scope_1562815358268;
    ...
    return function(e) {
        ...
        if (!var_init_locked_1562815358268) {

            stop = include('browser.event.stop');

            var_init_locked_1562815358268 = true;
        }



        if (!var_current_scope_1562815358268 !== this) {

            disabled = include('src::browser.event.gesture.tap.disabled').bind(this);
            dispatch = include('browser.event.dispatch').bind(this);

            var_current_scope_1562815358268 = this;
        }
...
exports['src::browser.event.gesture.tap.start.global'] = (() => {
    ...
    let var_init_locked_1562815358272;

    let var_current_scope_1562815358272;
    ...
    return function(e) {
        ...
        if (!var_init_locked_1562815358272) {

            getTouchEvents = include('browser.event.touches');
            stop = include('browser.event.stop');

            var_init_locked_1562815358272 = true;
        }



        if (!var_current_scope_1562815358272 !== this) {

            disabled = include('src::browser.event.gesture.tap.start.disabled').bind(this);

            var_current_scope_1562815358272 = this;
        }
...
exports['src::browser.event.gesture.tap.enabled'] = (() => {
    ...
    let var_init_locked_1562815358275;

    let var_current_scope_1562815358275;
    ...
    return function() {
        ...
        if (!var_init_locked_1562815358275) {

            getName = include('browser.event.name.single');
            on = include('browser.global.listener.add');

            var_init_locked_1562815358275 = true;
        }



        if (!var_current_scope_1562815358275 !== this) {
            ...
            var_current_scope_1562815358275 = this;
        }
...
exports['src::browser.event.gesture.tap.start'] = (() => {
    ...
    let var_init_locked_1562815358282;

    let var_current_scope_1562815358282;
    ...
    return function(e) {
        ...
        if (!var_init_locked_1562815358282) {
            ...
            var_init_locked_1562815358282 = true;
        }



        if (!var_current_scope_1562815358282 !== this) {

            enabled = include('src::browser.event.gesture.tap.enabled').bind(this);
            disabled = include('src::browser.event.gesture.tap.disabled').bind(this);

            var_current_scope_1562815358282 = this;
        }
...
exports['src::browser.event.gesture.name.start'] = (() => {
    ...
    let var_init_locked_1562815358289;
    ...
    return function(name) {
        ...
        if (!var_init_locked_1562815358289) {

            getName = include('browser.event.name.single');

            var_init_locked_1562815358289 = true;
        }
...
exports['src::browser.event.gesture.manager.dom'] = (() => {
    ...
    let var_init_locked_1562815358292;

    let var_class_1562815358292;

    let var_once_value_1562815358292;

    return function() {


        if (!var_init_locked_1562815358292) {

            getName = include('src::browser.event.gesture.name.start');
            createMap = include('map');

            var_init_locked_1562815358292 = true;
        }



        if (!var_class_1562815358292) {
            ...
            var_class_1562815358292 = class extends main {
                ...
                get ZBEE_CURRENT_CLASS() {
                    ...
                    return var_class_1562815358292;
                }
        ...
        if (var_once_value_1562815358292) {

            return var_once_value_1562815358292;

        }

        return var_once_value_1562815358292 = new var_class_1562815358292();
...
exports['src::miniprogram.page'] = (() => {
    ...
    let var_init_locked_1562815358298;
    ...
    return function(config) {
        ...
        if (!var_init_locked_1562815358298) {

            empty = include('function.empty')();
            isFunction = include('is.function');
            get = include('object.value.get');

            var_init_locked_1562815358298 = true;
        }
...
exports['src::directory.readAllFilePaths'] = (() => {
    ...
    let var_init_locked_1562815358306;
    ...
    return function(path, testRe) {
        ...
        if (!var_init_locked_1562815358306) {

            isDirectory = include('is.directory');
            isFile = include('is.file');

            var_init_locked_1562815358306 = true;
        }
...
exports['src::file.read'] = (() => {
    ...
    let var_init_locked_1562815358308;
    ...
    return function(path) {
        ...
        if (!var_init_locked_1562815358308) {

            isFile = include('is.file');

            var_init_locked_1562815358308 = true;
        }
...
exports['src::file.read.text'] = (() => {
    ...
    let var_init_locked_1562815358310;
    ...
    return function(path) {
        ...
        if (!var_init_locked_1562815358310) {

            read = include('file.read');

            var_init_locked_1562815358310 = true;
        }
...
exports['src::file.read.json'] = (() => {
    ...
    let var_init_locked_1562815358315;
    ...
    return function(path) {
        ...
        if (!var_init_locked_1562815358315) {

            read = include('file.read.text');
            parse = include('json.parse');

            var_init_locked_1562815358315 = true;
        }
...
exports['src::directory.create'] = (() => {
    ...
    let var_init_locked_1562815358318;
    ...
    return function(path) {
        ...
        if (!var_init_locked_1562815358318) {

            isDirectory = include('is.directory');

            var_init_locked_1562815358318 = true;
        }
...
exports['src::file.write'] = (() => {
    ...
    let var_init_locked_1562815358320;
    ...
    return function(path, data) {
        ...
        if (!var_init_locked_1562815358320) {

            create = include('directory.create');

            var_init_locked_1562815358320 = true;
        }
